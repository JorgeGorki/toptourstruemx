...
$enable_token = st()->get_option('vina_stripe_enable_token', 'off');
if($enable_token == 'on'){
    wp_enqueue_script( 'st-stripe-js' );
    wp_enqueue_style('stripe-css');
}

// $intent = ST_VinaStripe::get_inst()->get_PaymentIntent();
// $intent_update = ST_VinaStripe::get_inst()->update_PaymentIntent();
// echo $intent_update->id;
// echo $intent->id;
?>
<div class="pm-info">
    <div class="row">
