        ...
        <div class="thumb-caption">
            ...
            <p class="mb0 text-darken">
                ...
                <?php if($show_price == 'on' || $price): ?>
                    <span class="text-lg lh1em text-color"><?php echo TravelHelper::format_money($price) ?></span><small> /<?php echo ' '.esc_html($numberday).' '.esc_html__('night(s)', ST_TEXTDOMAIN); ?></small>
                <?php endif; ?>
            </p>
        </div>
    </div>
