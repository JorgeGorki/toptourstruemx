    ...
    <?php if(st()->get_option('allow_rental_advance_search')=='on'):?>
        ...
        <div class="search_advance">
            <div class="expand_search_box form-group-<?php echo esc_attr($field_size);?>">
                <span class="expand_search_box-more"> <i class="btn btn-primary fa fa-plus mr10"></i><?php echo esc_html__("Advanced Search",ST_TEXTDOMAIN) ; ?></span>
                <span class="expand_search_box-less"> <i class="btn btn-primary fa fa-minus mr10"></i><?php echo esc_html__("Advanced Search",ST_TEXTDOMAIN) ; ?></span>
            </div>
