...
<div class="st-create">
    ...
    ?>
    <a class="st_button_send_mail" href="<?php echo add_query_arg($arr_query_arg, get_permalink()); ?>" class="btn btn-primary btn-sm btn-sendmail-notice-link" title="<?php echo __('Send email notification depart date', ST_TEXTDOMAIN); ?>"><?php echo __('Send email notification', ST_TEXTDOMAIN); ?></a>
    <?php } ?>
        ...
        foreach ($posts as $key => $value) {
            ...
            <tr>
                ...
                <td >
                    ...
                    ?>
                    <a data-order-id="<?php echo esc_attr($value->order_item_id); ?>" data-id="<?php echo esc_attr($value->id); ?>" href="#" class="suser-approve"><?php echo __('Approve', ST_TEXTDOMAIN); ?> </a>
