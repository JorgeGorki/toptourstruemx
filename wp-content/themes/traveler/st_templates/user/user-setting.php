                ...
                <div class="partner-package-info">
                    <div class="row">
                        <div class="col-xs-12 col-sm-4">
                            ...
                            <?php
                                ...
                                if( $status == 'incomplete'){
                                    echo '<span class="order-status warning">'. balanceTags($status) . '</span>';
                                }elseif($status == 'completed'){
                                    echo '<span class="order-status success">'. balanceTags($status) . '</span>';
                                }elseif($status == 'cancelled'){
                                    echo '<span class="order-status danger">'. balanceTags($status) . '</span>';
                                }
                            ?>
                            <?php
                        ...
                        <div class="col-xs-12 col-sm-4">
                            ...
                            <div class="mt10 text-center">
                                <strong><?php echo __('Time Available', ST_TEXTDOMAIN); ?>: </strong><?php echo esc_html($admin_packages->convert_item($order->package_time, true)); ?>
                            </div>
                            <div class="mt10 text-center">
                    ...
                    <div class="input-group setting-avatar">
                        <span class="input-group-btn">
                            <span class="btn btn-primary btn-file" >
                                <span class="st-upload-avatar" data-multi="false" data-output="id"><?php _e("Avatar",ST_TEXTDOMAIN) ?></span>
                            </span>
                        </span>
