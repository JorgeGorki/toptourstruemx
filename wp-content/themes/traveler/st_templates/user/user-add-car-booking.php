      			...
      			<div class="panel-body">
	      			...
	      			<div class="row">
	      				<div class="col-xs-12 col-sm-12 st_check_book_none">
      						<div class="form-group">
		      					<label  for="item_price" class="head_bol"><?php _e('Price', ST_TEXTDOMAIN); ?>: <span id="label_price_car"></span></label>
      				...
      				<div class="row">
      					...
      					<div class="col-xs-12 col-sm-6">
      						<div class="form-group">
		      					<label for="pick_up" class="head_bol"><?php _e('Location', ST_TEXTDOMAIN);?> <span class="text-small text-danger">(*)</span>:</label>
		      					<?php
