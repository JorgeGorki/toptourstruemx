                ...
                <tr>
                    ...
                    if ($type_tour == 'daily_tour') {
                        ...
                        <td class="hidden-xs">
                            ...
                            if ($date) echo date('d/m/Y', strtotime($date)); ?><br/>
                            <?php echo esc_html(($value->starttime == '' ? '' : __('Start time', ST_TEXTDOMAIN) . ': ' . $value->starttime)); ?>
                        </td>
                    <?php }
                    ?>
                    ...
                    $countdown_string = '<span class="number-countdown">' . esc_html($date_diff) . '</span> ' . esc_html__('day(s)', ST_TEXTDOMAIN);
