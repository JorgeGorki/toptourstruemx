    ...
    <?php if($custom_layout_chart_info == "on"){ ?>
        ...
        <?php }elseif($request_custom_date['type']=="this_month" or $request_custom_date['type']=="this_year" ){ ?>
            ...
            <span class="hidden this_month user_dashboard"
                data-data_lable   = '<?php echo esc_attr(str_ireplace(array("'"),'\"',balanceTags($data_js['lable']))); ?>';
            ...
            <span class="hidden year user_dashboard"
                data-data_lable_year   = '<?php echo esc_attr(str_ireplace(array("'"),'\"',balanceTags($data_year_js['lable']))); ?>';
                data-data_sets_year   = '<?php echo esc_attr(str_ireplace(array("'"),'\"',balanceTags($data_year_js['data']))); ?>';
            ></span>
        <?php }else{ ?>
            <?php
            $start = $request_custom_date['start'];
