...
<div class="verify-box">
	<h3><?php echo __('Verifications Info', ST_TEXTDOMAIN); ?>
        ...
        ?>
			<button class="btn-verify-all" data-nonce="<?php echo wp_create_nonce( 'user_verifications' ); ?>" data-user_id="<?php echo esc_attr($data['user_id']); ?>" ><?php echo __('Verify all', ST_TEXTDOMAIN);  ?></button>
        <?php } ?>
	...
	<div class="verify-item">
		<div class="verify-label">
			...
			<button class="btn-verify-invalid" data-user_id="<?php echo esc_attr($data['user_id']); ?>" data-criteria="email"><?php echo __('Send notice', ST_TEXTDOMAIN); ?></button>
                <textarea rows="3" class="invalid-reason"></textarea>
            <?php }else{ ?>
                <?php echo STUser::verify_status_by_key($data['user_id'], 'email', true); ?>
                <button class="btn-verify-invalid" data-user_id="<?php echo esc_attr($data['user_id']); ?>" data-criteria="email"><?php echo __('Send notice', ST_TEXTDOMAIN); ?></button>
			<button class="btn-verify-single" data-user_id="<?php echo esc_attr($data['user_id']); ?>" data-criteria="email"><?php echo __('Verify', ST_TEXTDOMAIN); ?></button>
                <textarea rows="3" class="invalid-reason"></textarea>
            <?php } ?>
		</div>
	...
	<div class="verify-item">
		<div class="verify-label">
			...
			<button class="btn-verify-invalid" data-user_id="<?php echo esc_attr($data['user_id']); ?>" data-criteria="phone"><?php echo __('Send notice', ST_TEXTDOMAIN); ?></button>
                <textarea rows="3" class="invalid-reason"></textarea>
			<?php }else{ ?>
				<?php echo STUser::verify_status_by_key($data['user_id'], 'phone', true); ?>
                <button class="btn-verify-invalid" data-user_id="<?php echo esc_attr($data['user_id']); ?>" data-criteria="phone"><?php echo __('Send notice', ST_TEXTDOMAIN); ?></button>
			<button class="btn-verify-single" data-user_id="<?php echo esc_attr($data['user_id']); ?>" data-criteria="phone"><?php echo __('Verify', ST_TEXTDOMAIN); ?></button>
                <textarea rows="3" class="invalid-reason"></textarea>
            <?php } ?>
		</div>
		<div class="verify-value">
	...
	<div class="verify-item certificate idcard">
		<div class="verify-label">
            ...
            if(!$check_cer){
            ?>
			<button class="btn-verify-invalid" data-user_id="<?php echo esc_attr($data['user_id']); ?>" data-criteria="travel_certificate"><?php echo __('Send notice', ST_TEXTDOMAIN); ?></button>
                <textarea rows="3" class="invalid-reason"></textarea>
            <?php }else{ ?>
	            <?php echo STUser::verify_status_by_key($data['user_id'], 'travel_certificate', true); ?>
                <button class="btn-verify-invalid" data-user_id="<?php echo esc_attr($data['user_id']); ?>" data-criteria="travel_certificate"><?php echo __('Send notice', ST_TEXTDOMAIN); ?></button>
			<button class="btn-verify-single" data-user_id="<?php echo esc_attr($data['user_id']); ?>" data-criteria="travel_certificate"><?php echo __('Verify', ST_TEXTDOMAIN); ?></button>
			<textarea rows="3" class="invalid-reason"></textarea>
            <?php } ?>
		</div>
		<div class="verify-value">
    ...
    <div class="verify-item certificate idcard">
        <div class="verify-label">
			...
			<?php if(empty($data['social_facebook_uid']) && empty('social_facebook_name')){ ?>
                <button class="btn-verify-invalid" data-user_id="<?php echo esc_attr($data['user_id']); ?>" data-criteria="social"><?php echo __('Send notice', ST_TEXTDOMAIN); ?></button>
                <textarea rows="3" class="invalid-reason"></textarea>
			<?php }else{ ?>
				<?php echo STUser::verify_status_by_key($data['user_id'], 'social', true); ?>
                <button class="btn-verify-invalid" data-user_id="<?php echo esc_attr($data['user_id']); ?>" data-criteria="social"><?php echo __('Send notice', ST_TEXTDOMAIN); ?></button>
                <button class="btn-verify-single" data-user_id="<?php echo esc_attr($data['user_id']); ?>" data-criteria="social"><?php echo __('Verify', ST_TEXTDOMAIN); ?></button>
                <textarea rows="3" class="invalid-reason"></textarea>
			<?php } ?>
        </div>
        <div class="verify-value">
