    ...
    <div class="tab-content" id="myTabContent973">
        <div id="tab-booking-detail" class="tab-pane fade active in">
            <div class="info">
                ...
                <div class="col-md-12">
                    <div class="item_booking_detail">
                        <strong><?php esc_html_e("Tour Name",ST_TEXTDOMAIN) ?>:  </strong>
                        <a href="<?php echo get_the_permalink($service_id) ?>"><?php echo get_the_title($service_id) ?></a>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="item_booking_detail">
                        <strong><?php esc_html_e("Tour Type",ST_TEXTDOMAIN) ?>:  </strong>
                        <?php
                        $tour_name = '';
                                            ...
                                            <td>
                                                <label>
    								                <?php
                                                        ...
                                                        echo __('Departure time', ST_TEXTDOMAIN) . ': ' . esc_html($val->flight_departure_time) . '<br />';
    								                    echo __('Duration', ST_TEXTDOMAIN) . ': ' . esc_html($val->flight_duration);
                                                    ?>
                                                </label>
                                            </td>
                                            <td width="40%">
