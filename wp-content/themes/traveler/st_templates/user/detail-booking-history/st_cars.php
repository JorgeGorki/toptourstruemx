            ...
            <div class="info">
                <div class="row">
                    ...
                    <?php if($pickup=get_post_meta($order_id,'pick_up',true)): ?>
                        <div class="col-md-12">
                            <div class="item_booking_detail">
                                <strong><?php esc_html_e("Pick-up: ",ST_TEXTDOMAIN) ?>:  </strong>
                    ...
                    <?php if($drop_off=get_post_meta($order_id,'drop_off',true)): ?>
                        <div class="col-md-12">
                            <div class="item_booking_detail">
                                <strong><?php esc_html_e("Drop-off: ",ST_TEXTDOMAIN) ?>:  </strong>
                    ...
                    if(isset($car_title_sale_price['title_price']) && !empty($car_title_sale_price['title_price'])){ ?>
                        <div class="col-md-12">
                            <div class="item_booking_detail">
                                <strong><?php echo __('Price by number of day', ST_TEXTDOMAIN); ?>:</strong>
                                ...
                                <ul>
                                    <?php foreach($data_equipment_infor as $equipment){
                                        ...
                                        if($equipment["price_type"] == 'fixed'){
                                            ...
                                            echo esc_html(' x'.(int)$equipment["number_item"].')'.' x'.$date_diff).' '.__('Days',ST_TEXTDOMAIN) ;
                                        }
                                        echo "</li>";
                                    } ?>
                                </ul>
