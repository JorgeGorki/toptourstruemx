    ...
    if( $post_type == 'st_tours') {
        ...
        if($type_tour == 'daily_tour') {
            ...
            if ($date){
                ...
                $date .= __( "Duration : " , ST_TEXTDOMAIN ) . esc_html($duration). " ";
            }
        }
    }
?>
<div class="info">
	...
	<?php endif; ?>
	<div><strong><?php echo __('Execution Time: ', ST_TEXTDOMAIN); ?> </strong> <em><?php echo wp_kses($date, ['i' => ['class' => []]]); ?></em></div>
	<button class="btn btn-primary btn-sm mt10"><?php echo esc_html($status); ?></button>
	...
	<div class="clearfix"><strong><?php echo __('Cancellation Fee: ', ST_TEXTDOMAIN); ?></strong> <div class="pull-right"><strong><?php echo esc_html($percent) . '%'; ?></strong></div></div>
