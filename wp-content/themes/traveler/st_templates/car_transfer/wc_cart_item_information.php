...
<p class="booking-item-description">
    ...
    <br/>
    <?php echo __( 'Transfer:', ST_TEXTDOMAIN ); ?>
        ...
        <p class="booking-item-description">
            <?php
                if ( isset( $selected_extras ) and $selected_extras and !empty( $selected_extras ) ) {
                    echo "<b class='booking-cart-item-title'>" . __( 'Extras(s):', ST_TEXTDOMAIN ) . "</b>";
                    echo "</br>";
            ...
            <?php
                if ( isset($passenger ) and ($passenger > 0) ) {
                    echo "<b class='booking-cart-item-title'>" . __( 'Passenger(s) : ', ST_TEXTDOMAIN ) . "&nbsp;&nbsp;&nbsp;" . esc_html($passenger) ."</b>";
                    echo "<br>";
                }
            ?>
        </p>
