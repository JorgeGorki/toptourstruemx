...
<div class="row calendar-wrapper template-user" data-post-id="<?php echo esc_html($post_id); ?>">
    <div class="col-xs-12 col-md-8 calendar-wrapper-inner">
        ...
        <div class="calendar-content" data-price-by-per-person="<?php echo esc_attr( get_post_meta( $post_id, 'price_by_per_person', true ) == 'on' ? 'on' : 'off') ?>">
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    ...
                    <div class="row form-group"<?php echo (get_post_meta( $post_id, 'price_by_per_person', true ) != 'on') ? ' style="display: none;"' : '' ?>>
                        <div class="col-xs-6">
                            <label for="calendar_adult_price"><strong><?php echo __('Adult Price', ST_TEXTDOMAIN); ?></strong></label>
                        ...
                        <div class="col-xs-6">
                            <label for="calendar_child_price"><strong><?php echo __('Child Price', ST_TEXTDOMAIN); ?></strong></label>
                            <input type="text" name="calendar_child_price" id="calendar_child_price" class="form-control" placeholder="<?php echo __('Child Price', ST_TEXTDOMAIN); ?>">
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-xs-12">
