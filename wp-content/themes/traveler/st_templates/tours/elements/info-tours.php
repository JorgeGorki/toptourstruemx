        											        ...
        											        <?php foreach ($flight_package as $key => $val): ?>
                                                                <tr class="extra-collapse-control extra-none">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <label class="ml20 mb10"><input type="radio" class="i-check flight_package" name="flight_package[<?php echo esc_html($flight_id); ?>][]" value="<?php echo htmlspecialchars(json_encode($flight_package_data_economy)); ?>"/><span class="mt2 d-i-b"><?php echo __('Economy', ST_TEXTDOMAIN); ?> (<?php echo TravelHelper::format_money($val->flight_price_economy); ?>)</span></label>
