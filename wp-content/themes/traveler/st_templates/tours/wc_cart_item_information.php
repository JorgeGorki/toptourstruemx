...
<p class="booking-item-description"><span><?php echo __('Departure date', ST_TEXTDOMAIN); ?>: </span><?php echo esc_html(date_i18n( $format , strtotime( $data['check_in'] ) ) . ($data['starttime'] != '' ? ' - ' . $data['starttime'] : '')); ?></p>
...
<p class="booking-item-description"><span><?php echo __('Departure date', ST_TEXTDOMAIN); ?>: </span><?php echo esc_html(date_i18n( $format , strtotime( $data['check_in'] ) )); ?></p>
<p class="booking-item-description"><span><?php echo __('Return date', ST_TEXTDOMAIN); ?>: </span><?php echo esc_html(date_i18n( $format , strtotime( $data['check_out'] ) ) . ($data['starttime'] != '' ? ' - ' . $data['starttime'] : '')); ?></p>
<?php endif; ?>
<?php }else{ ?>
