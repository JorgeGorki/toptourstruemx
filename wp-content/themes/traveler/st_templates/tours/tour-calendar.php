    ...
    <?php endif; ?>
        ...
        <div class="form-content clearfix">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="">
                            <div class="calendar-starttime-wraper starttime-origin">
                                ...
                                <span dir="rtl"><i><?php echo __( 'hour', ST_TEXTDOMAIN ); ?></i></span>
                                ...
                                <span dir="rtl"><i><?php echo __( 'minute', ST_TEXTDOMAIN ); ?></i></span>
            ...
            <div style="margin-bottom: 15px">
                ...
                <span class="ml5"><?php echo __( 'Group day', ST_TEXTDOMAIN ) ?></span>
            </div>
