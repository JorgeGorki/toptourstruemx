...
<ul class="list list-inline text-small">
	<?php if($use_agent_info){?>
		...
		if(!empty($email))
			echo '<li><a href="mailto:'.esc_url($email).'"><i class="fa fa-envelope"></i> '.__('Agent E-mail',ST_TEXTDOMAIN).'</a> </li>';
		?>
	...
	<?php }else {?>
		...
		if(!empty($email))
			echo '<li><a href="mailto:'.esc_attr($email).'"><i class="fa fa-envelope"></i> '.__('Agent E-mail',ST_TEXTDOMAIN).'</a> </li>';
		?>
