            ...
            <ul>
                ...
                <li>
                    ...
                    <span class="value">
                        ...
                        $hour = ( $time[ 'hour' ] >= 2 ) ? esc_html($time[ 'hour' ]) . ' ' . esc_html__( 'hours', ST_TEXTDOMAIN ) : $time[ 'hour' ] . ' ' . esc_html__( 'hour', ST_TEXTDOMAIN );
                        $minute = ( $time[ 'minute' ] >= 2 ) ? esc_html($time[ 'minute' ]) . ' ' . esc_html__( 'minutes', ST_TEXTDOMAIN ) : esc_html($time[ 'minute' ]) . ' ' . esc_html__( 'minute', ST_TEXTDOMAIN );
                        echo esc_attr( $hour ) . ' ' . esc_attr( $minute ) . ' - ' .esc_html( $time['distance']) . __('Km', ST_TEXTDOMAIN);
                        ?>
                    </span>
                </li>
                <li>
                    <span class="label"><?php echo __('Pickup Date', ST_TEXTDOMAIN); ?></span>
                    ...
                    <li class="extra-value">
                        ...
                        foreach ($extras['value'] as $name => $number):
                            ...
                            if ($number_item > 0):
                                ...
                                <?php
                                    if($price_type == 'fixed'){
                                        echo esc_html( $extras['title'][$name]) . ' (' . TravelHelper::format_money($price_item) . ') x ' . esc_html($number_item) . ' ' . __('Item(s)', ST_TEXTDOMAIN);
                                    }else{
                                        echo esc_html($extras['title'][$name]) . ' (' . TravelHelper::format_money($price_item) . ') x ' . esc_html($number_item) . ' ' . __('Item(s)', ST_TEXTDOMAIN). ' x '.esc_html($days_extra).' '. __('Day(s)', ST_TEXTDOMAIN);
                                    }
                    ...
                    <li class="extra-value">
                        ...
                        foreach ($extras_new as $name => $number):
                            ...
                            <span class="pull-left">
                                <?php
                                    echo esc_html($number['title']) . ' (' . TravelHelper::format_money($price_item) . ') x ' . esc_html($number_item) . ' ' . __('Item(s)', ST_TEXTDOMAIN). ' x '.esc_html($days_extra).' '. __('Day(s)', ST_TEXTDOMAIN);
                ...
                if(isset($passengers) && $passengers > 0 ){ ?>
                    <li>
                        <span class="label"><?php echo __('Passengers', ST_TEXTDOMAIN); ?></span>
                        <span class="value"><?php echo esc_html($passengers); ?></span>
                    </li>
                <?php    }
                    if($item_id['data']['has_return'] === 'yes'){
                        echo '<li>
                                <span class="label">'. __("Direction Price", ST_TEXTDOMAIN).'</span>
                                <span class="value">'.TravelHelper::format_money($item_id['data']['price']).'</span>
                            </li>';
                        echo '<li>
                            <span class="label">'. __("Towards Price", ST_TEXTDOMAIN).'</span>
