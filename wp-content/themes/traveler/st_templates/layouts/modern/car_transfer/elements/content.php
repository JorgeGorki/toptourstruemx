...
<div class="col-lg-9 col-md-9">
    <?php echo st()->load_template('layouts/modern/car_transfer/elements/toolbar', '', array('style' => $style, 'format' => $format, 'layout' => $layout, 'service_text' => __('New', ST_TEXTDOMAIN), 'post_type' => 'st_car_transfer')); ?>
    ...
    <div class="pagination moderm-pagination" id="moderm-pagination" data-layout="normal">
        ...
        <span class="count-string">
            ...
            if ($query->found_posts):
                ...
                echo sprintf(__('%d - %d of %d ', ST_TEXTDOMAIN), ((int)$posts_per_page * ((int)$page - 1) + 1), $last, $query->found_posts );
                echo ( $query->found_posts == 1 ) ? __( 'Car Transfer', ST_TEXTDOMAIN ) : __( 'Cars Transfer', ST_TEXTDOMAIN );
            endif;
            ?>
        </span>
    </div>
