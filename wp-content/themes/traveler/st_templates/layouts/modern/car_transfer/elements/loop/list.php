            ...
            <div class="col-sm-8 padding-left-0 has-matchHeight">
                        ...
                        <div class="booking-item-features booking-item-features-small clearfix mt20">
                            <div class="st-choose-datetime">
                                <a class="st_click_choose_datetime" type="button"
                                    ...
                                    <?php echo __('Choose Pickup time', ST_TEXTDOMAIN); ?> <i class="fa fa-angle-down arrow"></i>      
                                </a>
                            </div>
                            <?php
                                ...
                                if(!empty($extra_price) and is_array($extra_price)){
                                    ...
                                    <div class="sroom-extra-service">
                                        <a class="st_click_choose_service" type="button"
                                            ...
                                            <?php echo __('Extra services ', ST_TEXTDOMAIN); ?> <i class="fa fa-angle-down arrow"></i>
                                ...
                                if($price_type === 'passenger'){ ?>
                                    <div class="sroom-passenger">
                                        <a class="st_click_choose_passenger" type="button"
                                            ...
                                            <?php echo __('Passenger ', ST_TEXTDOMAIN); ?> <i class="fa fa-angle-down arrow"></i>
                                            ...
                                            <div class="st-modal-dialog">
                                                ...
                                                <div class="st-modal-content">
                                                    <div class="form-group">
                                                        <label class="control-label"><?php echo __('Passenger', ST_TEXTDOMAIN);?></label>
                                                    <?php
                                ...
                                if(!empty($return_car) && ($return_car === 'yes')){ ?>
                                    <div class="sroom-return">
                                        <a class="st_click_choose_return" type="button"
                                            ...
                                            <?php echo __('Return ', ST_TEXTDOMAIN); ?> <i class="fa fa-angle-down arrow"></i>
                                        ...
                                        <div class="st-tooltip" id="extra-service-return-<?php echo get_the_ID(); ?>">
                                            <div class="st-modal-dialog">
                                                ...
                                                <div class="st-modal-content">
                                                    <div class="form-group">
                                                        <label class="control-label"><?php echo __('Return', ST_TEXTDOMAIN);?></label>
                                                        <div class="input-group">
                                                            <input type="radio" name="return_car"  value="yes"> <?php echo __('Yes', ST_TEXTDOMAIN);?> <br>
                                                            <input type="radio" name="return_car" checked value="no"> <?php echo __('No', ST_TEXTDOMAIN);?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="section-footer">
                    ...
                    <div class="service-price">
                        <span class="price">
                            <span class="st_cartransfer_price">
                                <?php echo TravelHelper::getNewIcon('thunder', '#ffab53', '10px', '16px'); ?><?php _e( " From ", ST_TEXTDOMAIN ) ?>
                            </span>
                            <?php
                    ...
                    <div class="service-price-book">
                        <input type="submit" name="booking_car_transfer" class="btn btn-primary btn-book_cartransfer" value="<?php echo __( 'Book Now', ST_TEXTDOMAIN ); ?>">
                    </div>
