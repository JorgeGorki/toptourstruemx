            ...
            <div class="dropdown-menu" aria-labelledby="dropdown-advance">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        ?>
                            <div class="item-title">
                                <h4><?php echo esc_html__( 'Passenger Number', ST_TEXTDOMAIN ) ?></h4>
                            </div>
                            <div class="item-content">
                                <div class="st-number">
                                    <div class="type-person">
                                        <span><?php echo __('Number of people', ST_TEXTDOMAIN); ?></span>
                                    </div>
                                ...
                                <!-- <input type="text" class="passenger_number" name="passenger_number"
                                       ...
                                       data-symbol="<?php echo esc_html__( 'Passenger', ST_TEXTDOMAIN ) ?>"
