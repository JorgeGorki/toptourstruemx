...
<a data-action='st_checkout' id ="demo-form" class="btn btn-primary btn-checkout btn-st-checkout-submit btn-st-big "><?php _e( 'Submit', ST_TEXTDOMAIN ) ?> <i class="fa fa-spinner fa-spin"></i></a>
