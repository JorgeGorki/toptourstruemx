    ...
    <div class="modal-dialog modal-dialog--width" role="document" style="max-width: 450px;">
        <div class="modal-content relative">
            ...
            <div class="modal-header">
                ...
                <span class="modal-sub-title"><?php echo esc_html__('Log in to add new things to your wishlist and access your any device') ?></span>
            </div>
              <div class="advanced">
                        <div class="row">
                                ...
                                <?php if (st_social_channel_status('facebook')): ?>
                                    <a onclick="return false" href="#"
                                       class="btn_login_fb_link st_login_social_link" data-channel="facebook">
                                           ...
                                           <span><?php  echo esc_html__('CONTINUE WITH FACEBOOK', ST_TEXTDOMAIN) ?></span>
                                    </a>
                                <?php endif; ?>
                            </div>
                            <div class="col-xs-12 col-sm-12">
                                <?php if (st_social_channel_status('google')): ?>
                                    <a href="javascript: void(0)" id="st-google-signin2"
                                       class="btn_login_gg_link st_login_social_link" data-channel="google">
                                           ...
                                           <span><?php echo esc_html__('CONTINUE WITH GOOGLE', ST_TEXTDOMAIN) ?></span>
                                    </a>
            ...
            <div class="modal-body relative">
                <form action="" class="form" method="post">
                    ...
                    <div class="form-group form-padding">
                        <label class="title-form"><?php echo esc_html__('Or',ST_TEXTDOMAIN) ?></label>
                    </div>
                    ...
                    <div class="mt20 c-grey font-medium f14 text-center">
                        <?php echo esc_html__('New here?', ST_TEXTDOMAIN) ?>
                        <a href=""
                           class="st-link open-signup"
                           data-toggle="modal"><?php echo esc_html__('Create an Account', ST_TEXTDOMAIN) ?></a>
                    </div>
                </form>
            </div>
        </div>
