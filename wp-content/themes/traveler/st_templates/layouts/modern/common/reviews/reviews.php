...
<?php
    ...
    switch ( $review_check ) {
        ...
        case "must_login":
            ...
            echo sprintf( st_get_language( 'you_must' ) . '<a href="' . esc_url($login_link) . '">' . __( 'log in ', ST_TEXTDOMAIN ) . '</a>' . st_get_language( 'to_write_review' ), get_permalink( st()->get_option( 'user_login_page' ) ) );
            echo '</div>';
            break;
        case "need_open":
            echo '<div class="box bg-gray">';
