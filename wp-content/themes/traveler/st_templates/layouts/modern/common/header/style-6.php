                        ...
                        if ($mega_menu == 'on') {
                            ...
                            <?php if(!is_user_logged_in()){ ?>
                                <div class="advance-menu">
                                    <a  href="" class="login" data-toggle="modal" data-target="#st-login-form"><?php echo esc_html__('Login',ST_TEXTDOMAIN) ?></a>

                                    <a href="" class="signup" data-toggle="modal" data-target="#st-register-form"><?php echo esc_html__('Sign Up',ST_TEXTDOMAIN) ?></a>
                                </div>
                            <?php } ?>
                            <?php
                        } else {
