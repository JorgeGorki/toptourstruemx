                                            ...
                                            <div class="form-book-wrapper">
                                                ...
                                                <div class="form-head">
                                                    ...
                                                    if (isset($number_day) && $number_day > 1)
                                                        echo wp_kses( sprintf( __( 'from <span class="price">%s</span> per %s nights', ST_TEXTDOMAIN ), TravelHelper::format_money($price), $number_day ), [ 'span' => [ 'class' => [] ] ] );
                                                    else
                                                        echo wp_kses( sprintf( __( 'from <span class="price">%s</span> per night', ST_TEXTDOMAIN ), TravelHelper::format_money($price) ), [ 'span' => [ 'class' => [] ] ] );
                                                    ?>
                                                </div>
                                                            ...
                                                            <form id="form-booking-inpage single-room-form" class="form single-room-form rental-booking-form" method="post">
                                                                ...
                                                                <div class="form-group form-extra-field dropdown clearfix field-guest <?php if ( $has_icon ) echo ' has-icon '; ?>">
                                                                    ...
                                                                    <div class="dropdown" data-toggle="dropdown" id="dropdown-1">
                                                                        ...
                                                                        <div class="render">
                                                                            <span class="adult" data-text="<?php echo __( 'Adult', ST_TEXTDOMAIN ); ?>" data-text-multi="<?php echo __( 'Adults', ST_TEXTDOMAIN ); ?>"><?php echo sprintf( _n( '%s Adult', '%s Adults', esc_attr($adult_number), ST_TEXTDOMAIN ), esc_attr($adult_number) ) ?></span>
                                                                            -
                                                                            <span class="children" data-text="<?php echo __( 'Child', ST_TEXTDOMAIN ); ?>"
                                                                                  data-text-multi="<?php echo __( 'Children', ST_TEXTDOMAIN ); ?>"><?php echo sprintf( _n( '%s Child', '%s Children', esc_attr($child_number), ST_TEXTDOMAIN ), esc_attr($child_number) ); ?></span>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="submit-group">
                                                                    <button class="btn btn-green btn-large btn-full upper font-medium btn_hotel_booking btn-book-ajax"
                                                                           type="submit"
                                                                           name="submit">
                                                                        <?php echo __( 'Book Now', ST_TEXTDOMAIN ) ?>
