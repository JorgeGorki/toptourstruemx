                            ...
                            <div class="items">
                                <div class="thumb">
                                    ...
                                    <span class="price">
                                            ...
                                            ?>
                                            <span class="text"><?php esc_html_e("/night", ST_TEXTDOMAIN) ?></span>
                                        </span>
                                </div>
            ...
            <div class="hotel-activity-list-room style-2">
                <div class="list-room-header">
                    <div class="header-left">
                        <h2 class="title">
                            <?php _e("Our Apartments", ST_TEXTDOMAIN) ?>
                        </h2>
                        <p class="description">
                            <?php echo sprintf(__("Our offers %s apartments in center the city", ST_TEXTDOMAIN), $number_show_room) ?>
                        </p>
                    </div>
                                            ...
                                            <div class="item item-list-room-overlay">
                                                <div class="info">
                                                    <div class="header">
                                                        ...
                                                        <span class="text">
                                                                    <?php _e('PER NIGHT', ST_TEXTDOMAIN) ?>
                                                                </span>
                                                    </div>
                                                    <h4 class="title">
