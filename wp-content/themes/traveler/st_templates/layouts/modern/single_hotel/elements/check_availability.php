            ...
            <form action="<?php echo esc_url($room_alone_search_page); ?>" class="st-room-check-available" method="get">
                <div class="sts-form-wrapper">
                    ...
                    <div class=" item field-detination">
                        <label> <?php echo __( 'location', ST_TEXTDOMAIN ); ?></label>
                    ...
                    <div class="item field-guest-new">
                        ...
                        <div class="dropdown" data-toggle="dropdown" id="dropdown-1">
                            <div class="render">
                                ...
                                <span class="adult" data-text="<?php echo __( 'Adult', ST_TEXTDOMAIN ); ?>" data-text-multi="<?php echo __( 'Adults', ST_TEXTDOMAIN ); ?>"><?php echo sprintf( _n( '%s Adult', '%s Adults', esc_attr($adult_num_search), ST_TEXTDOMAIN ), esc_attr($adult_num_search) ) ?></span>
                                <span class="line"><?php echo esc_html__(" - ",ST_TEXTDOMAIN) ?></span>
                                <span class="children" data-text="<?php echo __( 'Child', ST_TEXTDOMAIN ); ?>"
                                      data-text-multi="<?php echo __( 'Children', ST_TEXTDOMAIN ); ?>"><?php echo sprintf( _n( '%s Child', '%s Children', esc_attr($children_num_search), ST_TEXTDOMAIN ), esc_attr($children_num_search) ); ?></span>
                            </div>
                        </div>
                    ...
                    <button class="btn btn-primary sts-btn-white"><span><?php echo __('SEARCH', ST_TEXTDOMAIN); ?></span></button>
                </div>
            </form>
        </div>
   <?php }
