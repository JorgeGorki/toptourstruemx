        ...
        <div class="row has-matchHeight">
            <div class="col-lg-6 col-md-12 col-sm-6">
                <div class="thumb">
                    <?php if(is_user_logged_in()){ ?>
                        ...
                        <div class="service-add-wishlist login <?php echo ($data['status']) ? 'added' : ''; ?>" data-id="<?php echo get_the_ID(); ?>" data-type="<?php echo get_post_type($post_translated); ?>" title="<?php echo ($data['status']) ? __('Remove from wishlist', ST_TEXTDOMAIN) : __('Add to wishlist', ST_TEXTDOMAIN); ?>">
            ...
            <div class="col-lg-6 col-md-12 col-sm-6 item-content">
                ...
                <div class="service-review hidden-xs">
                    ...
                    <span class="review"><?php echo esc_attr($count_review) . ' ' . _n(esc_html__('Review', ST_TEXTDOMAIN),esc_html__('Reviews', ST_TEXTDOMAIN),$count_review); ?></span>
                </div>
