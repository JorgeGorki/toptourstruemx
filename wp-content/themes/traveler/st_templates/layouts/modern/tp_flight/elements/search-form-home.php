        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-2">
                <div class="form-button">
                    <button class="btn btn-primary btn-search btn-bookingdc-search-hotels <?php echo esc_attr($button_class); ?>" type="submit"><?php echo esc_html__('SEARCH', ST_TEXTDOMAIN); ?></button>
                </div>
            </div>
        </div>
