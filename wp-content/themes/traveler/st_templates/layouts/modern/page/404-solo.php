        ...
        <div class="row">
            <div class="item-content <?php echo esc_attr($class); ?>">
                ...
                if ($option_404) {
                    ...
                    ?>
                    <h1><?php echo __('404, Page Not Found!', ST_TEXTDOMAIN); ?></h1>
                    <p><?php echo __("Something's wrong here. You have traveled out of the world", ST_TEXTDOMAIN); ?></p>
                    <p><a href="<?php echo site_url('/'); ?>"><?php echo __('BACK TO HOMEPAGE', ST_TEXTDOMAIN); ?></a></p>
                <?php } ?>
            </div>
            <?php if ($img_404) { ?>
