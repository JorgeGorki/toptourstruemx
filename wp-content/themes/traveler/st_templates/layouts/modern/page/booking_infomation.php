...
<div class="row booking-success-notice">
	...
	<div class="col-lg-4 col-md-4">
		<ul class="booking-info-detail">
			...
			<li><span><?php echo __('Status:', ST_TEXTDOMAIN); ?></span> <?php echo ucfirst(get_post_meta($order_code, 'status', true)); ?></li>
		</ul>
	</div>
</div>
<div class="row">
	<div class="col-lg-4 col-md-4 col-lg-push-8 col-md-push-8">
		...
		<div class="cart-info">
			...
			<div class="total-section">
                ...
                $adult_label = get_post_meta($key, 'adult_label', true);
                $child_label = get_post_meta($key, 'child_label', true);
                $infant_label = get_post_meta($key, 'infant_label', true);
                    ...
                    if ($post_type != 'st_flight') {
                        if (isset($data_price['adult_price']) && isset($data_price['child_price']) && isset($data_price['infant_price'])) {
                            ...
                            <?php if ($adult_price) { ?>
                                <li><span class="label"><?php 
                                    ...
                                    ?></span><span
                                            class="value"><?php echo TravelHelper::format_money($adult_price, $currency); ?></span>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($child_price) { ?>
                                <li><span class="label"><?php 
                                    ...
                                    ?></span><span
                                            class="value"><?php echo TravelHelper::format_money($child_price, $currency); ?></span>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($infant_price) { ?>
                                <li><span class="label"><?php
                                    ...
                                    ?></span><span
                                            class="value"><?php echo TravelHelper::format_money($infant_price, $currency); ?></span>
                                </li>
                            <?php } ?>
                            <?php
                        }
                        ...
                        if ($key == 'car_transfer') {
                            ...
                            <li>
                                ...
                                <span class="value"><?php echo TravelHelper::format_money($base_price, $currency); ?></span>
                            </li>
                            <li>
                                <span class="label"><?php echo __('Extra price', ST_TEXTDOMAIN); ?></span>
                                <span class="value"><?php echo TravelHelper::format_money($extra_price, $currency); ?></span>
                            </li>
                        ...
                        if ( isset($discount_rate) && $discount_rate > 0 ): ?>
                            <li>
                                ...
                                if ( isset($discount_type) && $discount_type == 'amount' ) { ?>
                                    <span class="value"><?php echo esc_html(TravelHelper::format_money($discount_rate, $currency)); ?></span>
                                    <?php
                                } else { ?>
                                    <span class="value"><?php echo esc_html($discount_rate . '%') ?></span>
                                    <?php
                        ...
                        <li>
                            ...
                            <span class="value"><?php echo TravelHelper::format_money($sale_price, $currency); ?></span>
                        </li>
                        ...
                        <?php if (!empty($hotel_package) and is_array($hotel_package) && count($hotel_package)) { ?>
                            <li>
                                ...
                                <span class="value"><?php echo TravelHelper::format_money($hotel_package_price, $currency); ?></span>
                            </li>
                        <?php } ?>
                        <?php if (!empty($activity_package) and is_array($activity_package) && count($activity_package)) { ?>
                            <li>
                                ...
                                <span class="value"><?php echo TravelHelper::format_money($activity_package_price, $currency); ?></span>
                            </li>
                        <?php } ?>
                        <?php if (!empty($car_package) and is_array($car_package) && count($car_package)) { ?>
                            <li>
                                ...
                                <span class="value"><?php echo TravelHelper::format_money($car_package_price, $currency); ?></span>
                            </li>
                        <?php } ?>
                        <?php if (!empty($flight_package) and is_array($flight_package) && count($flight_package)) { ?>
                            <li>
                                ...
                                <span class="value"><?php echo TravelHelper::format_money($flight_package_price, $currency); ?></span>
                            </li>
                        <?php } ?>
                        <?php if (isset($data_price['price_equipment'])) { ?>
                            <li>
                                <span class="label"><?php echo __('Equipment Price', ST_TEXTDOMAIN); ?></span>
                                                            <span class="value"><?php echo TravelHelper::format_money($price_equipment, $currency); ?></span>
                            </li>
                        <?php } ?>
                        <li>
                        ...
                        <?php if ($coupon_price) { ?>
                            <li>
                                ...
                                <span class="value"> - <?php echo TravelHelper::format_money($coupon_price, $currency); ?></span>
                            </li>
                        <?php } ?>
                        ...
                        <?php if (is_array($deposit_status) && !empty($deposit_status['type']) && floatval($deposit_status['amount']) > 0) { ?>
                            <li>
                                ...
                                <span class="value"><?php echo TravelHelper::format_money($deposit_price, $currency); ?></span>
                            </li>
                            <?php
                            if (!empty($booking_fee_price = get_post_meta($order_code, 'booking_fee_price', true))) {
                                ...
                                <li>
                                    ...
                                    <span class="value"><?php echo TravelHelper::format_money($booking_fee_price, $currency); ?></span>
                                </li>
                            <?php } ?>
                            <li>
                                <span class="label"><?php echo __('Total', ST_TEXTDOMAIN); ?></span>
                                <span class="value"><?php echo TravelHelper::format_money($price_with_tax, $currency); ?></span>
                            </li>
                            <li>
                                <span class="label"><?php echo __('Pay Amount', ST_TEXTDOMAIN); ?></span>
                                <span class="value"><?php echo TravelHelper::format_money($total_price, $currency); ?></span>
                            </li>
                        <?php } else { ?>
                            <?php
                            if (!empty($booking_fee_price = get_post_meta($order_code, 'booking_fee_price', true))) {
                            ...
                            <li class="payment-amount">
                                ...
                                <span class="value">
                                    ...
                                    // echo TravelHelper::format_money($price_with_tax + $booking_fee_add_total, $currency);
                                    echo TravelHelper::format_money($total_price + $booking_fee_add_total, $currency);
                                    ?>
                                </span>
                            </li>
                        <?php
