...
if (isset($item_id) and $item_id):
    ...
    <div class="info-section">
        <ul>
            ...
            <!--Add Info-->
            <li>
                <span class="label"><?php echo __('Address Rent Car', ST_TEXTDOMAIN); ?></span>
            ...
            if (isset($item['data']['car_title_sale_price']['title_price']) && !empty($item['data']['car_title_sale_price']['title_price'])) { ?>
                <li>
                    <span class="label"><?php echo __('Price by number of day', ST_TEXTDOMAIN); ?></span>
                </li>
            ...
            <?php if (isset($extras['value']) && is_array($extras['value']) && count($extras['value'])): ?>
                ...
                <li class="extra-value">
                    ...
                    switch ($unit_extra) {
                        case 'distance':
                        case 'hour':
                            $text_unit_extra = __('Hour(s)', ST_TEXTDOMAIN);
                            break;
                        default:
                            $text_unit_extra = __('Day(s)', ST_TEXTDOMAIN);
                            break;
                    }
                    foreach ($extras['value'] as $name => $number):
                        ...
                        if ($number_item > 0):
                            ...
                            if ($price_type == 'fixed') {
                                ...
                                echo esc_html($extras['title'][$name]) . ' (' . TravelHelper::format_money($price_item) . ') x ' . esc_html($number_item) . ' ' . __('Item(s)', ST_TEXTDOMAIN) . ' x ' . esc_html($days_extra) . ' ' . esc_html($text_unit_extra);
                            }
