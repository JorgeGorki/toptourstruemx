                ...
                <div class="form-extra-field dropdown">
                    ...
                    <div class="dropdown-menu sort-menu" aria-labelledby="dropdownMenuSort">
                        ...
                        <div class="sort-item st-icheck">
                            <div class="st-icheck-item"><label> <?php echo __('New car', ST_TEXTDOMAIN); ?><input class="service_order" type="radio" name="service_order_<?php echo esc_attr($format); ?>" data-value="new"/><span class="checkmark"></span></label></div>
                        </div>
                        <div class="sort-item st-icheck">
