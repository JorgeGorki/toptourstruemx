                            ...
                            <div class="st-program">
                                <div class="st-title-wrapper">
                                    ...
                                    <?php if($tour_program_style == 'style1'){ ?>
                                        <span class="expand" data-ex="1" data-text-more="<?php echo esc_html__('Expand All', ST_TEXTDOMAIN); ?>" data-text-less="<?php echo esc_html__('Collapse All', ST_TEXTDOMAIN); ?>"><?php echo esc_html__('Expand All', ST_TEXTDOMAIN); ?></span>
                                    <?php } ?>
                                </div>
