                    ...
                    <div class="st-gallery">
                        ...
                        <div class="btn-group">
                            ...
                            <?php if(!empty($gallery)){?>
                               ...
                               class="btn btn-transparent has-icon radius st-gallery-popup"><?php echo TravelHelper::getNewIcon('camera-retro', '#FFFFFF', '18px', '18px') ?><?php echo __('More Photos', ST_TEXTDOMAIN) ?></a>
                            <?php }?>
                            <div id="st-gallery-popup" class="hidden">
                                <?php
                                if (!empty($gallery_array)) {
                                    foreach ($gallery_array as $k => $v) {
                                        echo '<a href="' . wp_get_attachment_image_url($v, 'full') . '">' . esc_html__('Image', ST_TEXTDOMAIN) . '</a>';
                                    }
                                }
                                ?>
                            </div>
                                ...
                                <div class="st-title-wrapper">
                                    ...
                                    <?php if ($tour_program_style == 'style1') { ?>
                                        <span class="expand" data-ex="1"
                                              data-text-more="<?php echo esc_html__('Expand All', ST_TEXTDOMAIN); ?>"
                                              data-text-less="<?php echo esc_html__('Collapse All', ST_TEXTDOMAIN); ?>"><?php echo esc_html__('Expand All', ST_TEXTDOMAIN); ?></span>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="st-include">
                                        <div class="row">
                                            <?php if ( !empty( $include ) ) { ?>
                                                <div class="col-lg-6">
                                                    <h3 class="st-section-title">
                                                        <?php echo __( 'Included', ST_TEXTDOMAIN ); ?>
                                                    </h3>
                                                    <ul class="include">
                                                        <?php
                                                            $in_arr = explode( "\n", $include );
                                            ...
                                            <?php if ( !empty( $exclude ) ) { ?>
                                                <div class="col-lg-6">
                                                    <h3 class="st-section-title">
                                                        <?php echo __( 'Buy on site', ST_TEXTDOMAIN ); ?>
                                                    </h3>
                                                    <ul class="exclude">
                                                        <?php
                                                            $ex_arr = explode( "\n", $exclude );
                                                            if ( !empty( $ex_arr ) ) {
                                                                foreach ( $ex_arr as $k => $v ) {
                                                                    echo '<li>' . TravelHelper::getNewIcon( 'money-wallet', '#FA5636', '18px', '18px', false ) . esc_html($v) . '</li>';
                                                                }
                                                            }
                                                        ?>
                                                    </ul>
