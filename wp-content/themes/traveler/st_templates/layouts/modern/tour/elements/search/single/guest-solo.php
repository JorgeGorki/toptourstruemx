...
$tour_guest_childrent = st()->get_option('tour_guest_childrent', __('Age 6-17', ST_TEXTDOMAIN));
    ...
    <div class="dropdown st-tour-booking__flex" data-toggle="dropdown" id="dropdown-1">
        ...
        <div class="st-tour-booking__tour-info tour-info render">
            <span class="adult" data-text="<?php echo esc_html__('Adult', ST_TEXTDOMAIN); ?>"
                  data-text-multi="<?php echo esc_html__('Adults', ST_TEXTDOMAIN); ?>"><?php echo sprintf(_n('%s Adult', '%s Adults', esc_attr($adult_number), ST_TEXTDOMAIN), $adult_number) ?></span>
            ,
            <span class="children" data-text="<?php echo esc_html__('Children', ST_TEXTDOMAIN); ?>"
                  data-text-multi="<?php echo esc_html__('Children', ST_TEXTDOMAIN); ?>"><?php echo sprintf(_n('%s Child', '%s Children', esc_attr($child_number), ST_TEXTDOMAIN), $child_number); ?></span>
            ,
            <span class="infant" data-text="<?php echo esc_html__('Infant', ST_TEXTDOMAIN); ?>"
                  data-text-multi="<?php echo esc_html__('Infant', ST_TEXTDOMAIN); ?>"><?php echo sprintf(_n('%s Infant', '%s Infant', esc_attr($infant_number), ST_TEXTDOMAIN), $infant_number); ?></span>
        </div>
            ...
            <li class="item">
                <div class="guest-wrapper st-tour--guest-wraper clearfix">
                    <div class="st-tour-booking__check-in check-in-wrapper">
                        ...
                        <div class="st-tour-booking__render render"><?php echo sprintf(__('%s', ST_TEXTDOMAIN), $tour_guest_adult); ?></div>
                    </div>
            ...
            <li class="item">
                <div class="guest-wrapper clearfix">
                    <div class="st-tour-booking__check-in check-in-wrapper">
                        ...
                        <div class="st-tour-booking__render render"><?php echo sprintf(__('%s', ST_TEXTDOMAIN), $tour_guest_childrent); ?></div>
                    </div>
                    <div class="select-wrapper">
                        <div class="st-tour-booking__st--number st-number-wrapper">
            ...
            <li class="item">
                <div class="guest-wrapper clearfix">
                    <div class="st-tour-booking__check-in check-in-wrapper">
                        ...
                        <div class="st-tour-booking__render render"><?php echo sprintf(__('%s', ST_TEXTDOMAIN), $tour_guest_infant); ?></div>
                    </div>
                    <div class="select-wrapper">
                        <div class="st-tour-booking__st--number st-number-wrapper">
