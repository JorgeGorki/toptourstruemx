...
<div class="form-group form-more-extra">
    <!-- <a href="#dropdown-more-extra" class="dropdown"><?php echo esc_html__( 'Extras', ST_TEXTDOMAIN ) ?>
    ...
    <!-- <ul class="extras"> -->
        <?php foreach ( $extra_price as $key => $val ):
            if ( isset( $val[ 'extra_required' ] ) && $val[ 'extra_required' ] == 'on' ) {
                ?>
                <div class="item mt10">
                <div class="st-flex space-between" style="border-bottom: 1px solid #EAEEF3;">
                        <div>
                            <h5 style="font-size: 16px;"><?php echo esc_html($val['title']); ?></h5>
                            <p><?php echo TravelHelper::format_money( $val[ 'extra_price' ] ) ?></p>
                        </div>
                        <div class="select-wrapper" style="width: 50px;">
                            ...
                            <select class="form-control app extra-service-select"
                                    ...
                                    style="border: none; color: #2196F3; font-size: 16px"
