...
$tour_id = $key;
// Custom labels
$adult_label = get_post_meta($tour_id, 'adult_label', true);
$child_label = get_post_meta($tour_id, 'child_label', true);
$infant_label = get_post_meta($tour_id, 'infant_label', true);
                ...
                <span class="label">
                    <?php 
                        if(! empty($adult_label)){
                            _e('No. ' . $adult_label,ST_TEXTDOMAIN) ;
                        } else {
                            _e('No. Adult',ST_TEXTDOMAIN) ;
                        }
                    ?>
                </span>
                <span class="value">
            ...
            <li>
                ...
                <?php 
                    if(! empty($child_label)){
                        _e('No. ' . $child_label,ST_TEXTDOMAIN) ;
                    } else {
                        _e('No. Children',ST_TEXTDOMAIN) ;
                    }
                ?>
                </span>
                <span class="value">
            ...
            <li>
                ...
                <?php 
                    if(! empty($infant_label)){
                        _e('No. ' . $infant_label,ST_TEXTDOMAIN) ;
                    } else {
                        _e('No. Infant',ST_TEXTDOMAIN) ;
                    }
                ?>
                </span>
                <span class="value">
                ...
                <?php
                    foreach ($extras['value'] as $name => $number):
                        ...
                        if ($number_item > 0) {
                            ?>
                            <span>
                    <?php echo esc_html($extras['title'][$name]) . ' (' . TravelHelper::format_money($price_item) . ') x ' . esc_html($number_item) . ' ' . __('Item(s)', ST_TEXTDOMAIN); ?>
                </span> <br/>
                            <?php
                        }
                    endforeach;
