    ...
    <div class="row st-loadmore loadmore-ccv">
        ...
        <div class="text-center st-button-loadmore">
            ...
            <div class="control-loadmore text-center">
                <a class="load_more_post st-button--main" href="#" data-posts-per-page="<?php echo (int) $posts_per_page; ?>" data-paged="1" type_service="<?php echo esc_attr($service); ?>"  data-id_service = "<?php echo esc_attr($ids) ?>" check-all="true" ><?php echo esc_html__('Load more', ST_TEXTDOMAIN) ?></a>
