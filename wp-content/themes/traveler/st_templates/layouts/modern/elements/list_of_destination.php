                                ...
                                if (count($service) == 1) {
                                    ...
                                    switch ($service[0]) {
                                        case 'st_hotel':
                                            ...
                                            echo sprintf(_n('%s Hotel', '%s Hotels', $total, ST_TEXTDOMAIN), $total);
                                            echo '</a>';
                                            break;
                                        case 'st_rental':
                                            $total = STLocation::count_services($location_id, "'st_rental'");
                                            echo '<a href="' . esc_url($result_page) . '">';
                                            echo sprintf(_n('%s Rental', '%s Rentals', $total, ST_TEXTDOMAIN), $total);
                                            echo '</a>';
                                            break;
                                        case 'st_tours':
                                        ...
                                        case 'st_cars':
                                            $total = STLocation::count_services($location_id, '"' . $service[0] . '"');
                                            echo '<a href="' . esc_url($result_page) . '">';
                                            echo sprintf(_n('%s Car', '%s Cars', $total, ST_TEXTDOMAIN), $total);
                                            echo '</a>';
                                            break;
                                    }
                                    echo '</div>';
                                    ...
                                    foreach ($service as $kk => $vv) {
                                        ...
                                        switch ($vv) {
                                            case 'st_hotel':
                                                ...
                                                $result_page = add_query_arg(['location_name' => $location_name, 'location_id' => $location_id], $result_page);
                                                $desc_str .= '<li><a href="' . esc_url($result_page) . '">' . sprintf(_n('%s Hotel', '%s Hotels', $total, ST_TEXTDOMAIN), $total) . '</a></li>';
                                                break;
                                            case 'st_rental':
                                                $result_page = get_the_permalink(st()->get_option('rental_search_result_page'));
                                                $result_page = add_query_arg(['location_name' => $location_name, 'location_id' => $location_id], $result_page);
                                                $desc_str .= '<li><a href="' . esc_url($result_page) . '">' . sprintf(_n('%s Rental', '%s Rentals', $total, ST_TEXTDOMAIN), $total) . '</a></li>';
                                                break;
                                            case 'st_tours':
                                                $result_page = get_the_permalink(st()->get_option('tours_search_result_page'));
                                                $result_page = add_query_arg(['location_name' => $location_name, 'location_id' => $location_id], $result_page);
                                                $desc_str .= '<li><a href="' . esc_url($result_page) . '">' . sprintf(_n('%s Tour', '%s Tours', $total, ST_TEXTDOMAIN), $total) . '</a></li>';
                                                break;
                                            case 'st_activity':
                                                $result_page = get_the_permalink(st()->get_option('activity_search_result_page'));
                                                $result_page = add_query_arg(['location_name' => $location_name, 'location_id' => $location_id], $result_page);
                                                $desc_str .= '<li><a href="' . esc_url($result_page) . '">' . sprintf(_n('%s Activity', '%s Activities', $total, ST_TEXTDOMAIN), $total) . '</a></li>';
                                                break;
                                            case 'st_cars':
                                                $result_page = get_the_permalink(st()->get_option('cars_search_result_page'));
                                                $result_page = add_query_arg(['location_name' => $location_name, 'location_id' => $location_id], $result_page);
                                                $desc_str .= '<li><a href="' . esc_url($result_page) . '">' . sprintf(_n('%s Car', '%s Cars', $total, ST_TEXTDOMAIN), $total) . '</a></li>';
                                                break;
                                        }
                                    }
                                        ...
                                        foreach ($service as $kk => $vv) {
                                            ...
                                            switch ($vv) {
                                                ...
                                                case 'st_cars':
                                                    $result_page = get_the_permalink(st()->get_option('cars_search_result_page'));
                                                    $result_page = add_query_arg(['location_name' => $location_name, 'location_id' => $location_id], $result_page);
                                                    $desc_str .= '<a href="' . esc_url($result_page) . '">' . sprintf(_n('%s Car', '%s Cars', $total, ST_TEXTDOMAIN), $total) . '</a>';
                                                    break;
                                            }
                                        }
