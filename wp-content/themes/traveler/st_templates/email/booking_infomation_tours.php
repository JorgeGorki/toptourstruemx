...
$adult_label = get_post_meta($post_id, 'adult_label', true);
$child_label = get_post_meta($post_id, 'child_label', true);
$infant_label = get_post_meta($post_id, 'infant_label', true);
                        ...
                        <td style="padding: 6px;vertical-align: top;border-bottom:1px dashed #ccc;border-left: 1px solid #bcbcbc;border-bottom: 1px solid #bcbcbc;border-right: 1px solid #bcbcbc;">
                            ...
                            <p><strong><?php 
                                if(!empty($child_label)){
                                    _e($child_label, ST_TEXTDOMAIN) ;
                                }else{
                                    _e('Child Price',ST_TEXTDOMAIN) ;
                                }
                            ?>: </strong>
