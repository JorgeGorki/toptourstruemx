                    ...
                    if ($check_upgrade) {
                        ...
                        <?php }else{
                                ...
                                <div class="sidebar-header">
                                    ...
                                    ?>
                                        <div class="user-upgrade">
                                            <a href="<?php echo esc_url($admin_packages->register_member_page()); ?>" title=""><?php _e('Upgrade',ST_TEXTDOMAIN);?></a>
                                        </div>
                                    <?php } ?>
                                </div>
                                <?php
                                    ...
                                    <div class="sidebar-submenu">
                                        <ul>
                                            ...
                                            <li <?php if ($sc == 'add-cartransfer-booking')
                                                echo 'class="active"' ?>><a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'add-cartransfer-booking'); ?>"><?php _e("Add Booking Car Transfer", ST_TEXTDOMAIN) ?>
                                                </a>
                                            </li>
