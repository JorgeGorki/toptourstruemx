        ...
        function init_metabox()
        {
            ...
            $this->metabox[] = [
                ...
                'fields' => [
                    ...
                    [
                        'label' => __('Price with per person', ST_TEXTDOMAIN),
                        'id' => 'price_by_per_person',
                        'type' => 'on-off',
                        'std' => 'off',
                        'desc' => __('It allows calculate price with per person', ST_TEXTDOMAIN)
                    ],
                    [
                    ...
                    [
                        'label' => sprintf(__('Adult Pricing (%s)', ST_TEXTDOMAIN), TravelHelper::get_default_currency('symbol')),
                        'id' => 'adult_price',
                        'type' => 'text',
                        'desc' => __('The price per adult', ST_TEXTDOMAIN),
                        'condition' => 'price_by_per_person:is(on)'
                    ],
                    [
                        'label' => sprintf(__('Child Pricing (%s)', ST_TEXTDOMAIN), TravelHelper::get_default_currency('symbol')),
                        'id' => 'child_price',
                        'type' => 'text',
                        'desc' => __('The price per child', ST_TEXTDOMAIN),
                        'condition' => 'price_by_per_person:is(on)'
                    ],
                    [
                    ...
                    [
                        'label' => __('Room Facility Preview', ST_TEXTDOMAIN),
                        'id' => 'room_facility_preview',
                        'type' => 'upload',
                        'class' => '',
                        'desc' => __('Upload the hotel room detail facilities preview', ST_TEXTDOMAIN),
                    ],
                    [
