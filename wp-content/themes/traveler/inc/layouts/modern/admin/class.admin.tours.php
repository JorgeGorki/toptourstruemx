    ...
    class STAdminTours extends STAdmin {
        ...
        public function st_tour_type_add_fields() {
            ...
            <div class="form-field">
                <label class="stt-submit-text" > <?php echo esc_html__('Attachment', ST_TEXTDOMAIN) ?></label>
                <div class="stt-edit-avatar">

                </div>
                <input type="hidden" name="upload_value" value="">
                <div class="stt-upload-avatar">
                    <input type="button" class="button button-defautl stt-update-avatar" value="<?php echo esc_html__('Upload Image', ST_TEXTDOMAIN) ?>">
        ...
        public function st_tour_type_set_colums($columns) {
            $newColumns = array(
                'image' => esc_html__('Image', ST_TEXTDOMAIN),
            );
        ...
        static function _getInfoTour() {
            ...
            if (get_post_type($tour_id) == 'st_tours') {
                ...
                if ($type_tour && $type_tour == 'daily_tour') {
                    ...
                    $result['label_type_tour'] = __('Daily Tour', ST_TEXTDOMAIN);
                    ...
                    $result['type_tour'] = $html;
                    $result['tour_text'] = $type_tour;
                    $result['label_type_tour'] = __('Specific Date', ST_TEXTDOMAIN);
        ...
        function init_metabox() {
            ...
            $this->metabox[] = [
                ...
                'fields' => [
                    ...
                    [
                        'label' => __('Is Iframe', ST_TEXTDOMAIN),
                        'id' => 'is_iframe',
                        'type' => 'on-off',
                        'desc' => __('Turn on/off Iframe', ST_TEXTDOMAIN),
                        'std' => 'off'
                    ],
                    [
                        'label' => __('Iframe', ST_TEXTDOMAIN),
                        'id' => 'map_iframe',
                        'type' => 'textarea',
                        'desc' => __('Enter the iframe you took on google map', ST_TEXTDOMAIN),
                    ...
                    [
                        ...
                        'choices' => [
                            [
                                'label' => __('Instant Booking', ST_TEXTDOMAIN),
                                'value' => 'instant'
                            ],
                            [
                                'label' => __('Enquire Booking', ST_TEXTDOMAIN),
                                'value' => 'enquire'
                            ],
                            [
                                'label' => __('Instant & Enquire Booking', ST_TEXTDOMAIN),
                    ...
                    [
                        'label' => __('Base price label', ST_TEXTDOMAIN),
                        'id' => 'base_label',
                        'type' => 'text',
                        'std' => 0,
                        'condition' => 'tour_price_by:is(fixed)'
                    ...
                    [
                        'label' => __('Adult age range', ST_TEXTDOMAIN),
                        'id' => 'adult_age',
                        'type' => 'text',
                        'desc' => __('Age to be considered an adult', ST_TEXTDOMAIN),
                        'std' => 0,
                        'condition' => 'hide_adult_in_booking_form:is(off),tour_price_by:not(fixed)'
                    ],
                    [
                        'label' => __('Adult price label', ST_TEXTDOMAIN),
                        'id' => 'adult_label',
                        'type' => 'text',
                        'desc' => __('Price per adult label', ST_TEXTDOMAIN),
                        'std' => 0,
                        'condition' => 'hide_adult_in_booking_form:is(off),tour_price_by:not(fixed)'
                    ],
                    [
                    ...
                    [
                        'label' => __('Child age', ST_TEXTDOMAIN),
                        'id' => 'child_age',
                        'type' => 'text',
                        'desc' => __('Age to be considered a child', ST_TEXTDOMAIN),
                        'std' => 0,
                        'condition' => "hide_children_in_booking_form:is(off),tour_price_by:not(fixed)"
                    ],
                    [
                        'label' => __('Child price label', ST_TEXTDOMAIN),
                        'id' => 'child_label',
                        'type' => 'text',
                        'desc' => __('Price per Child Label', ST_TEXTDOMAIN),
                        'std' => 0,
                        'condition' => "hide_children_in_booking_form:is(off),tour_price_by:not(fixed)"
                    ],
                    [
                    ...
                    [
                        'label' => __('Infant age', ST_TEXTDOMAIN),
                        'id' => 'infant_age',
                        'type' => 'text',
                        'desc' => __('Age to be considered an infant', ST_TEXTDOMAIN),
                        'std' => 0,
                        'condition' => "hide_infant_in_booking_form:is(off),tour_price_by:not(fixed)"
                    ],
                    [
                        'label' => __('Infant price label', ST_TEXTDOMAIN),
                        'id' => 'infant_label',
                        'type' => 'text',
                        'desc' => __('Price per Infant Label', ST_TEXTDOMAIN),
                        'std' => 0,
                        'condition' => "hide_infant_in_booking_form:is(off),tour_price_by:not(fixed)"
                    ],
                    [
                        'label' => __('Fields list discount by infant number booking', ST_TEXTDOMAIN),
                        'id' => 'discount_by_infant',
                        'type' => 'list-item',
                        'desc' => __('Fields list discount by infant number booking', ST_TEXTDOMAIN),
                        'std' => 0,
                        'settings' => [
                            [
                                'id' => 'key',
                                'label' => __('Number of infant (From)', ST_TEXTDOMAIN),
                                'type' => 'text',
                            ],
                            [
                                'id' => 'key_to',
                                'label' => __('Number of infant (To)', ST_TEXTDOMAIN),
                                'type' => 'text',
                            ],
                            [
                                'id' => 'value',
                    ...
                    [
                        ...
                        'label' => __('Type calculator of discount by people', ST_TEXTDOMAIN),
                        'type' => 'select',
                        'choices' => [
                            [
                                'label' => __('Total', ST_TEXTDOMAIN),
                                'value' => 'total'
                            ],
                            [
                                'label' => __('Person', ST_TEXTDOMAIN),
                                'value' => 'person'
                            ]
                        ],
                        'condition' => "tour_price_by:not(fixed)"
                    ...
                    [
                        ...
                        'id' => 'discount',
                        'type' => 'text',
                        'desc' => __('Discount of this tour (percent | amount)', ST_TEXTDOMAIN),
                        'std' => 0
                    ],
                    [
                    ...
                    [
                        'label' => __('Deposit percent', ST_TEXTDOMAIN),
                    ...
                    [
                        ...
                        'choices' => [
                            ...
                            [
                                'label' => __("Background image width text", ST_TEXTDOMAIN),
                                'value' => 'style4'
                            ],
                        ],
                        'std' => 'style1'
                    ...
                    [
                        ...
                        'label' => __("Overview Background Image", ST_TEXTDOMAIN),
                        'type' => 'upload',
                    ],
                    [
                        'id' => 'tours_highlight_bg_img',
                        'label' => __("Tour Highlight Background Image", ST_TEXTDOMAIN),
                        'type' => 'upload',
                    ],
                    [
                        'id' => 'tours_related_bg_img',
                        'label' => __("Related Tour Background Image", ST_TEXTDOMAIN),
                        'type' => 'upload',
                    ],
                    [
                     ...
                     */
                    [
                        'label' => __('Group tour', ST_TEXTDOMAIN),
                        'id' => 'st_group_tour_tab',
                        'type' => 'tab'
                    ],
                    [
                        'label' => __('This tour has a group variation', ST_TEXTDOMAIN),
                        'id' => 'st_group_tour_tab',
                        'type' => 'on-off',
                        'std' => 'off'
                    ],
                    [
                        'label' => __('Select the on demand tour', ST_TEXTDOMAIN),
                        'id' => 'single_tour_id',
                        'type' => 'select',
                        'choices' => $options,
                        'desc' => __('Select the related tour', ST_TEXTDOMAIN),
                        'condition' => 'st_group_tour_tab:is(on)'
                    ],
                    // End Tour package
                    [
            ...
            if ($column_name == 'price') {
                ...
                if (!empty($discount)) {
                    ...
                    if ($is_sale_schedule == "on") {
                        ...
                        if (isset($discount_type) && $discount_type == 'amount') {
                            echo '<span>' . __('Discount rate', ST_TEXTDOMAIN) . ' : ' . TravelHelper::format_money($discount) . '</span><br>';
                        } else {
                            echo '<span>' . __('Discount rate', ST_TEXTDOMAIN) . ' : ' . $discount . $str_discount_type . '</span><br>';
                        }
        ...
        static function _get_st_tours_ondemnd_option_list () {
            $st_tours = TravelHelper::get_posts_by_type('st_tours');
            $options = array();
            foreach($st_tours as $tour){
                $options [] = [
