...
class ST_Admin_Settings extends STAdmin {
    ...
    public function tp_locale_default_filter() {
        $tp_locale_default = [
            [
                'value' => 'ar',
                'label' => esc_html__('Arabic', ST_TEXTDOMAIN)
            ],
            [
                'value' => 'ez',
    ...
    public function __otherSettings() {
        return [
            ...
            [
                ...
                'label' => __('Enable Google map', ST_TEXTDOMAIN),
                'type' => 'on-off',
                'std' => 'on',
                'section' => 'option_bc',
            ],
            [
                ...
                'label' => __('Enable MapBox', ST_TEXTDOMAIN),
                'type' => 'on-off',
                'std' => 'on',
                'section' => 'option_bc',
            ...
            [
                'id' => 'st_token_mapbox',
                'label' => __('Token MapBox', ST_TEXTDOMAIN),
                'desc' => __('Input your Token key ', ST_TEXTDOMAIN) . "<a target='_blank' href='https://account.mapbox.com'>How to get it?</a>",
                'type' => 'text',
                'section' => 'option_bc',
        ...
        return [/* ------------- Search Option ----------------- */
            ...
            [
                ...
                'choices' => [
                    ...
                    [
                        'id' => 'setting_partner',
                        'label' => __('Disable user option ', ST_TEXTDOMAIN),
                        'section' => 'option_partner',
                        'type' => 'on-off',
                        'desc' => __('ON: Disable partner, OFF: Able partner', ST_TEXTDOMAIN),
                        'std' => 'off'
                    ],
                    [
                        'value' => 'ID',
    ...
    public function __partnerSettings() {
        return [/* ------------- Option Partner Option -------------------- */
            ...
            [
                'id' => 'setting_partner',
                'label' => __('User registration option ', ST_TEXTDOMAIN),
                'section' => 'option_partner',
                'type' => 'on-off',
                'desc' => __('ON: Allow partner, OFF: Not allow partner', ST_TEXTDOMAIN),
                'std' => 'on'
            ],
            [
    ...
    public function __hotelAloneSettings() {
        return [/* ----------- Hotel Alone Options-------------- */
            ...
            [
                'id' => 'st_room_taxonomy',
                'label' => __('Room taxonomy', ST_TEXTDOMAIN),
                'type' => 'term_image',
                'section' => 'option_hotel_alone',
                'std' => ''
            ],
            ...
            [
                ...
                'label' => __('Logo Light options', ST_TEXTDOMAIN),
                'desc' => __('To change logo', ST_TEXTDOMAIN),
                'type' => 'upload',
                'section' => 'option_hotel_alone',
            ],
            ...
            [
                ...
                'label' => __('Select list of rooms page', ST_TEXTDOMAIN),
                'desc' => __('Select the page to display list of rooms ', ST_TEXTDOMAIN),
                'type' => 'post-select-ajax',
                'post_type' => 'page',
                'sparam' => 'page',
                'section' => 'option_hotel_alone',
            ...
            [
                ...
                'label' => __('Sidebar: Facebook URL', ST_TEXTDOMAIN),
                'type' => 'text',
                'desc' => __('Example: https://example.com', ST_TEXTDOMAIN),
                'std' => '',
                'section' => 'option_hotel_alone',
            ],
            [
                'id' => 'st_hotel_alone_social_instagram_url',
                'label' => __('Sidebar: Instagram URL', ST_TEXTDOMAIN),
                'type' => 'text',
                'desc' => __('Example: https://example.com', ST_TEXTDOMAIN),
                'std' => '',
                'section' => 'option_hotel_alone',
            ...
            [
                ...
                'label' => __('Sidebar: Twitter URL', ST_TEXTDOMAIN),
                'type' => 'text',
                'desc' => __('Example: https://example.com', ST_TEXTDOMAIN),
                'std' => '',
                'section' => 'option_hotel_alone',
            ...
            [
                ...
                'choices' => [
                    ...
                    [
                        'id' => 'menu-left',
                        'alt' => __('Menu Left', ST_TEXTDOMAIN),
                        'src' => get_template_directory_uri() . '/img/nav6.png'
                    ],
                    [
                        'id' => 'menu-style-3',
                        'alt' => __('Menu Style 3', ST_TEXTDOMAIN),
    ...
    public function __activitySettings() {
        return [/* ------------- Activity Option  ----------------- */
            ...
            [
                ...
                'desc' => __('ON: Show featured activities on top of default result search page', ST_TEXTDOMAIN),
                'type' => 'on-off',
                'std' => 'off',
                'section' => 'option_activity'
            ],
            [
                ...
                'label' => __('Advance search', ST_TEXTDOMAIN),
                'type' => 'select',
                'std' => '',
            ...
            [
                ...
                'label' => __('Type filter Option Attribute', ST_TEXTDOMAIN),
                'type' => 'select',
                'std' => '',
                'choices' => array(
                    [
            ...
            [
                ...
                'label' => __('Age restriction for Adult', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_activity',
                'std' => __('Age 18+', ST_TEXTDOMAIN),
            ],
            [
                'id' => 'activity_guest_childrent',
                'label' => __('Age restriction for Children', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_activity',
                'std' => __('Age 6-17', ST_TEXTDOMAIN),
            ],
            [
                'id' => 'activity_guest_infant',
                'label' => __('Age restriction for Infant', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_activity',
                'std' => __('Age 0-5', ST_TEXTDOMAIN),
            ],
            [
                'id' => 'icon_duration_single_activity',
                'label' => __('Icon Duration Single Activity', ST_TEXTDOMAIN),
                'desc' => __('Example: <i class="lar la-clock"></i> : Link search icon : https://icons8.com/line-awesome', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_activity',
            ...
            [
                ...
                'label' => __('Icon Cancel Single Activity', ST_TEXTDOMAIN),
                'desc' => __('Example: <i class="las la-ban"></i> : Link search icon : https://icons8.com/line-awesome', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_activity',
            ...
            [
                ...
                'label' => __('Icon Group Size Single Activity', ST_TEXTDOMAIN),
                'desc' => __('Example: <i class="las la-user-friends"></i> : Link search icon : https://icons8.com/line-awesome', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_activity',
            ...
            [
                ...
                'label' => __('Icon Language Single Activity', ST_TEXTDOMAIN),
                'desc' => __('Example: <i class="las la-language"></i> : Link search icon : https://icons8.com/line-awesome', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_activity',
    ...
    public function __tourSettings() {
        return [/* ------------- Activity - Tour Option  ----------------- */
            ...
            [
                'id' => 'tour_form_fields',
                'label' => __('Setting Form Field(Only use for style 2)', ST_TEXTDOMAIN),
                'desc' => esc_html__('Display fields in the form(Maximum of 4 field)', ST_TEXTDOMAIN),
                'type' => 'select_ui',
                'section' => 'option_activity_tour',
                'max_choice' => 4,
                'left_label' => __('Choose form field', ST_TEXTDOMAIN),
                'right_label' => __('Show field', ST_TEXTDOMAIN),
                'choices' => [
                    [
            ...
            [
                ...
                'choices' => [
                    ...
                    [
                        'value' => '4',
                        'label' => __('Layout 4', ST_TEXTDOMAIN)
                    ],
                    [
                        'value' => '5',
                        'label' => __('Layout 5', ST_TEXTDOMAIN)
                    ],
                    [
                        'value' => '6',
                        'label' => __('Layout 6', ST_TEXTDOMAIN)
                    ],
                    [
                        'value' => '7',
                        'label' => __('Layout 7', ST_TEXTDOMAIN)
                    ],
                ],
                'std' => '1'
            ],
            ...
            [
                ...
                'desc' => __('ON: Show featured tours on top of default result search page', ST_TEXTDOMAIN),
                'type' => 'on-off',
                'std' => 'off',
                'section' => 'option_activity_tour'
            ],
            ...
            ['id' => 'tour_package_service_with',
                'label' => __('Accompanied service', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_activity_tour',
                'std' => __('Hotel, Car, Flight...', ST_TEXTDOMAIN),
            ],
                /* ------------- Activity - Tour Option  ----------------- */

            [
                'id' => 'icon_duration_single_tour',
                'label' => __('Icon Duration Single Tour', ST_TEXTDOMAIN),
                'desc' => __('Example: <i class="lar la-clock"></i> : Link search icon : https://icons8.com/line-awesome', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_activity_tour',
                'std' => '<i class="lar la-clock"></i>'
            ...
            [
                ...
                'label' => __('Icon Tour Type Single Tour', ST_TEXTDOMAIN),
                'desc' => __('Example: <i class="las la-shoe-prints"></i> : Link search icon : https://icons8.com/line-awesome', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_activity_tour',
            ...
            [
                ...
                'label' => __('Icon Group size Single Tour', ST_TEXTDOMAIN),
                'desc' => __('Example: <i class="las la-user-friends"></i> : Link search icon : https://icons8.com/line-awesome', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_activity_tour',
                'std' => '<i class="las la-user-friends"></i>'
            ...
            [
                ...
                'label' => __('Icon Language Single Tour', ST_TEXTDOMAIN),
                'desc' => __('Example: <i class="las la-language"></i> : Link search icon : https://icons8.com/line-awesome', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_activity_tour',
                'std' => '<i class="las la-language"></i>'
    ...
    public function __carSettings() {
        return [/* ------------- Cars Option ----------------- */
            ...
            [
                ...
                'label' => __('Items per page', ST_TEXTDOMAIN),
                'desc' => __('Number of items on a car results search page', ST_TEXTDOMAIN),
                'type' => 'number',
                'max' => 50,
                'min' => 1,
                'step' => 1,
            ...
            [
                ...
                'desc' => __('Show featured cars on top of default result search page', ST_TEXTDOMAIN),
                'type' => 'on-off',
                'std' => 'off',
                'section' => 'option_car'
            ],
    ...
    public function __rentalSettings() {
        return [/* ------------- Rental Option ----------------- */
            ...
            [
                ...
                'label' => __('Items per page', ST_TEXTDOMAIN),
                'desc' => __('Number of items on a rental results search page', ST_TEXTDOMAIN),
                'type' => 'number',
                'max' => 50,
                'min' => 1,
                'step' => 1,
            ...
            [
                ...
                'desc' => __('ON: Show featured items on top of default result search page', ST_TEXTDOMAIN),
                'type' => 'on-off',
                'std' => 'off',
                'section' => 'option_rental'
            ],
    ...
    public function __advanceSettings() {
        return [
            ...
            [
                    'id' => 'start_week',
                'label' => __('Start Week', ST_TEXTDOMAIN),
                'type' => 'select',
                'choices' => [
                        [
                                'value' => '0',
            ...
            [
                ...
                'label' => __('Inquiry Shortcode Contact Form 7', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_advance',
                'std' => '',
            ],
    ...
    public function __blogSettings() {
        return [
            ...
            [
                ...
                'label' => __('Select Blog list style', ST_TEXTDOMAIN),
                'desc' => __('Select styles of blog (it is default as style 1)', ST_TEXTDOMAIN),
                'type' => 'radio-image',
                'section' => 'option_blog',
                'std' => '1',
                'choices' => [
                    ...
                    [
                        ...
                        'alt' => __('Blog Style solo', ST_TEXTDOMAIN),
            ...
            [
                ...
                'label' => __('Select Blog Single style', ST_TEXTDOMAIN),
                'desc' => __('Select styles of blog (it is default as style 1)', ST_TEXTDOMAIN),
                'type' => 'radio-image',
                'section' => 'option_blog',
                'std' => '1',
    ...
    public function __bookingSettings() {
        $r = [
            ...
            [
                ...
                'desc' => __('Enable captcha for booking form. It is applied for normal booking form : link https://www.google.com/recaptcha/admin', ST_TEXTDOMAIN),
                'type' => 'on-off',
                'std' => 'on',
                'section' => 'option_booking',
            ...
            [
                ...
                'label' => __('Site key', ST_TEXTDOMAIN),
                'desc' => __('Use this site key in the HTML code your site serves to users. : https://www.google.com/recaptcha/admin', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_booking',
            ...
            [
                ...
                'desc' => __('Use this secret key for communication between your site and reCAPTCHA', ST_TEXTDOMAIN),
                'type' => 'text',
                'section' => 'option_booking',
                'condition' => 'booking_enable_captcha:is(on)'
            ],
    ...
    public function __hotelSettings() {
        $r = [
            ...
            [
                ...
                'label' => esc_html__('Availability Check', ST_TEXTDOMAIN),
                'desc' => esc_html__('OFF: Do not check availability in search results.', ST_TEXTDOMAIN),
                'type' => 'on-off',
                'std' => 'off',
                'section' => 'option_hotel',
            ],
            [
                ...
                'label' => esc_html__('Distance to Nearby hotels', ST_TEXTDOMAIN),
                'type' => 'text',
                'std' => '25',
                'section' => 'option_hotel',
            ],
    ...
    public function __hotelRoomSettings() {
        return [
            ...
            [
                'id' => 'room_review',
                'label' => __('Review options', ST_TEXTDOMAIN),
                'desc' => __('ON: Turn on the mode for reviewing room', ST_TEXTDOMAIN),
                'type' => 'on-off',
            ...
            [
                ...
                'label' => __('Review criteria', ST_TEXTDOMAIN),
                'desc' => __('You can add, sort review criteria for room', ST_TEXTDOMAIN),
                'type' => 'list-item',
                'section' => 'option_hotel_room',
    ...
    public function __styleSettings() {
        return [
            ...
            [
                'id' => 'link_color',
                'label' => __('Link Color', ST_TEXTDOMAIN),
                'desc' => __('To change the link color for web', ST_TEXTDOMAIN),
                'type' => 'colorpicker',
                'section' => 'option_style',
                'std' => '#5191FA',
            ],
            ...
            [
                ...
                'choices' => [
                    ...
                    [
                        'id' => '4',
                        'alt' => __('Header Transparent Tour Style1', ST_TEXTDOMAIN),
                        'src' => get_template_directory_uri() . '/img/nav7.png'
                    ],
                    [
                        'id' => '5',
                        'alt' => __('Header Transparent Tour Style2', ST_TEXTDOMAIN),
                        'src' => get_template_directory_uri() . '/img/nav8.png'
                    ],
                    [
                        'id' => '6',
                        'alt' => __('Header Transparent Tour Style3', ST_TEXTDOMAIN),
                        'src' => get_template_directory_uri() . '/img/nav9.png'
                    ],
                    [
                        'id' => '7',
                        'alt' => __('Header Lite Style 2', ST_TEXTDOMAIN),
                        'src' => get_template_directory_uri() . '/img/header-style7.png'
                    ],
                    [
                        'id' => '8', //auto load layout.modern.common.header
                        'alt' => __('Header Style solo', ST_TEXTDOMAIN),
            ...
            [
                'id' => 'footer_tab',
                'label' => __('Footer', ST_TEXTDOMAIN),
                'type' => 'tab',
                'section' => 'option_style',
            ],
            [
                'id' => 'st_text_copyright',
                'label' => __("Copyright Text", ST_TEXTDOMAIN),
                'desc' => __("Copyright text", ST_TEXTDOMAIN),
                'type' => 'textarea-simple',
                'section' => 'option_style',
                'class' => '',
            ...
            [
                'id' => 'st_card_accept',
                'label' => __("Card Accept", ST_TEXTDOMAIN),
                'desc' => __("Card Accept", ST_TEXTDOMAIN),
                'type' => 'upload',
                'section' => 'option_style',
                'class' => '',
    ...
    public function __generalSettings() {
        return [
            ...
            [
                'id' => '404_style',
                'label' => __('404 Style Layout', ST_TEXTDOMAIN),
                'desc' => __('Select layout to 404 page ', ST_TEXTDOMAIN),
                'type' => 'custom-select',
                'section' => 'option_general',
                'choices' => [
                    [
            ...
            [
                'id' => '404_bg_color',
                'label' => __('Background color of 404 page', ST_TEXTDOMAIN),
                'desc' => __('To change background color for 404 page', ST_TEXTDOMAIN),
                'type' => 'colorpicker',
                'section' => 'option_general',
            ],
            [
                'id' => '404_img',
                'label' => __('Image of 404 page', ST_TEXTDOMAIN),
                'desc' => __('To change image for 404 page', ST_TEXTDOMAIN),
                'type' => 'upload',
                'section' => 'option_general',
            ],
            [
