...
if (!class_exists('STHotel')) {
    class STHotel extends TravelerObject
    {
        ...
        public function st_filter_hotel_ajax_location()
        {
            ...
            <span class="count-string">
                    ...
                    if ($query_service->found_posts):
                        ...
                        echo ($query_service->found_posts == 1) ? __('Hotel', ST_TEXTDOMAIN) : __('Hotels', ST_TEXTDOMAIN);
                    endif;
                    ?>
                </span>
            <?php
        ...
        function do_add_to_cart()
        {
            ...
            if ($adult_number*$room_num_search > $adult*$room_num_search) {
                STTemplate::set_message(sprintf(__('Max of adults is %d people.', ST_TEXTDOMAIN), $adult*$num_room), 'danger');
                $pass_validate = false;
                return false;
            }
