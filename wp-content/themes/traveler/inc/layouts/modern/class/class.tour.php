    ...
    class STTour extends TravelerObject {
        ...
        public function st_filter_tour_ajax_location() {
            ...
            <span class="count-string">
                ...
                if ($query_service->found_posts):
                    ...
                    echo ( $query_service->found_posts == 1 ) ? __('Tour', ST_TEXTDOMAIN) : __('Tours', ST_TEXTDOMAIN);
                endif;
                ?>
            </span>
            <?php
        ...
        function do_add_to_cart() {
            ...
            if ($adult_number + $child_number + $infant_number < $min_number) {
                STTemplate::set_message(sprintf(__('Min number of people for this tour is %d people', ST_TEXTDOMAIN), $min_number), 'danger');
                $pass_validate = FALSE;
                return false;
            }
            /**
            ...
            if ($tour_price_by != 'fixed_depart') {
                ...
                if (!$tour_available) {
                    STTemplate::set_message(__('The check in, check out day is invalid or this tour not available.', ST_TEXTDOMAIN), 'danger');
                    $pass_validate = false;
                    return false;
                }
            }
