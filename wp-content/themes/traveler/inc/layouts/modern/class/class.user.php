                ...
                <span class="count-string">
                    <?php
                        ...
                        if ( $wp_query->found_posts ):
                            ...
                            echo ( $wp_query->found_posts == 1 ) ? __( 'Hotel', ST_TEXTDOMAIN ) : __( 'Hotels', ST_TEXTDOMAIN );
                        endif;
                    ?>
                </span>
                <?php
                ...
                <span class="count-string">
                    <?php
                        ...
                        if ( $wp_query->found_posts ):
                            ...
                            if ( $last > $wp_query->found_posts ) $last = $wp_query->found_posts;
                            echo sprintf( __( '%d - %d of %d ', ST_TEXTDOMAIN ), $posts_per_page * ( $page - 1 ) + 1, $last, $wp_query->found_posts );
                            echo ( $wp_query->found_posts == 1 ) ? __( 'Tour', ST_TEXTDOMAIN ) : __( 'Tours', ST_TEXTDOMAIN );
                        endif;
                    ?>
                </span>
                <?php
                ...
                <span class="count-string">
                    <?php
                        ...
                        if ( $wp_query->found_posts ):
                            ...
                            if ( $last > $wp_query->found_posts ) $last = $wp_query->found_posts;
                            echo sprintf( __( '%d - %d of %d ', ST_TEXTDOMAIN ), $posts_per_page * ( $page - 1 ) + 1, $last, $wp_query->found_posts );
                            echo ( $wp_query->found_posts == 1 ) ? __( 'Rental', ST_TEXTDOMAIN ) : __( 'Rentals', ST_TEXTDOMAIN );
                        endif;
                    ?>
                </span>
                <?php
                ...
                <span class="count-string">
                    <?php
                        ...
                        if ( $wp_query->found_posts ):
                            ...
                            if ( $last > $wp_query->found_posts ) $last = $wp_query->found_posts;
                            echo sprintf( __( '%d - %d of %d ', ST_TEXTDOMAIN ), $posts_per_page * ( $page - 1 ) + 1, $last, $wp_query->found_posts );
                            echo ( $wp_query->found_posts == 1 ) ? __( 'Activity', ST_TEXTDOMAIN ) : __( 'Activities', ST_TEXTDOMAIN );
                        endif;
                    ?>
                </span>
                <?php
        ...
        */
            ...
            public function _st_reset_password()
            {
                ...
                if ( $url_confirm_reset ){
                    $message = '';
                    $to      = $email;
                    $subject = __( 'Confirm reset password', ST_TEXTDOMAIN );
                    $sender  = get_option( 'name' );
                    $message .= __( 'Someone has requested a password reset for the following account:', ST_TEXTDOMAIN ).'<br>' ;
                    $message .= __( 'Site Name', ST_TEXTDOMAIN ).': '.get_bloginfo( 'name' ).'<br>' ;
                    $message .= __( 'Username', ST_TEXTDOMAIN ).': '.$user_login.'<br>' ;
                    $message .= __( 'If this was a mistake, just ignore this email and nothing will happen.', ST_TEXTDOMAIN ).'<br>' ;
                    $message .= __( 'To reset your password, visit the following address:', ST_TEXTDOMAIN ).'<br>'.$url_confirm_reset;
