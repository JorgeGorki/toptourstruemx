    ...
    class STRental extends TravelerObject
    {
        ...
        function __construct()
        {
            $this->orderby = [
                'new' => [
                    'key' => 'new',
                    'name' => esc_html__('New', ST_TEXTDOMAIN)
                ],
                'price_asc' => [
                    'key' => 'price_asc',
                    'name' => esc_html__('Price ', ST_TEXTDOMAIN) . ' (<i class="fa fa-long-arrow-up"></i>)'
                ],
                'price_desc' => [
                    'key' => 'price_desc',
                    'name' => esc_html__('Price ', ST_TEXTDOMAIN) . ' (<i class="fa fa-long-arrow-down"></i>)'
                ],
                'name_a_z' => [
                    'key' => 'name_a_z',
                    'name' => esc_html__('Name (A-Z)', ST_TEXTDOMAIN)
                ],
                'name_z_a' => [
                    'key' => 'name_z_a',
                    'name' => esc_html__('Name (Z-A)', ST_TEXTDOMAIN)
                ],
            ];
        }
        /**
            ...
            add_filter( 'pre_get_posts', [ $this, 'removeSearchServiceLocationByAuthor' ] );
                ...
                <span class="count-string">
                    ...
                    if ($query_service->found_posts):
                        ...
                        echo ( $query_service->found_posts == 1 ) ? __( 'Rental', ST_TEXTDOMAIN ) : __( 'Rentals', ST_TEXTDOMAIN );
                    endif;
                    ?>
                </span>
                <?php
