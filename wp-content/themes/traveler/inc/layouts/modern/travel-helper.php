...
if (!class_exists('TravelHelper')) {
    ...
    class TravelHelper {
        ...
        public static function get_posts_by_type($post_type, $post_status = 'publish') {
            $args = array(
                'post_type'=> $post_type,
        ...
        static function get_rate_review_text($review, $count = null) {
            ...
            if ($review > 4) {
                ...
                $string = esc_html__('Not Rated', ST_TEXTDOMAIN);
            }
            if ($count !== null) {
                if ($count <= 0) {
                    $string = esc_html__('Not Rated', ST_TEXTDOMAIN);
        ...
        static function comment_form($args = [], $post_id = null) {
            ...
            $defaults = [
                ...
                'logged_in_as' => '<p class="logged-in-as">' . sprintf(
                        ...
                        __('<a class="st-link" href="%1$s" aria-label="%2$s">Logged in as %3$s</a>. <a class="st-link" href="%4$s">Log out?</a>'), get_edit_user_link(),
