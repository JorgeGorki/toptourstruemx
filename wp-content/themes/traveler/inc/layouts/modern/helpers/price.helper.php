    ...
    class STPrice{
        ...
        static function showRoomPriceInfo($room_id = '', $check_in = '', $check_out = ''){
            ...
            if ( $price_by_per_person == 'on' ) {
                $html .= '<li class="head"><span class="label">' . __('From - To', ST_TEXTDOMAIN) . '</span><span class="value">' . __('Adult Price', ST_TEXTDOMAIN) . '</span><span class="value">' . __('Child Price', ST_TEXTDOMAIN) . '</span></li>';
            } else {
                $html .= '<li class="head"><span class="label">' . __('From - To', ST_TEXTDOMAIN) . '</span><span class="value">' . __('Price', ST_TEXTDOMAIN) . '</span></li>';
            }
            if(get_post_type($room_id) == 'hotel_room'){
                $room_origin_id = TravelHelper::post_origin($room_id, 'hotel_room');
                $custom_price = AvailabilityHelper::_getdataHotel($room_origin_id, $check_in, $check_out);
