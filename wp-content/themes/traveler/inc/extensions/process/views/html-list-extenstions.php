...
<h1 class="wp-heading-inline"><?php echo esc_html(__('Extensions','traveler')); ?></h1>
    <nav class="nav-tab-wrapper wpm-nav-tab-wrapper st-tab-extendsion">
        <a href="<?php echo admin_url().'admin.php?page=st-vina-extensions&extension-tab=list'; ?>" class="nav-tab <?php if(!isset($_GET['extension-tab'])){echo 'nav-tab-active';}?>"><?php echo esc_html('Plugins',ST_TEXTDOMAIN)?></a>
        <a href="<?php echo admin_url().'admin.php?page=st-vina-extensions&extension-tab=extendsion'; ?>" class="nav-tab <?php if(isset($_GET['extension-tab']) && $_GET['extension-tab']==='extendsion'){echo 'nav-tab-active';}?>"><?php echo esc_html('Extension',ST_TEXTDOMAIN)?></a>
    </nav>
    <?php
