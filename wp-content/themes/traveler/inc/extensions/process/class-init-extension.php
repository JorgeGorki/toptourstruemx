    ...
    function install_plugin_information_extension(){
        ...
        <div id="plugin-information-scrollable">
            ...
            <div id="plugin-information-tabs" class="with-banner">
                <a name="description" href="#" class="current"><?php echo __('Description', ST_TEXTDOMAIN);?></a>
            </div>
            <div id="plugin-information-content" class="with-banner">
                <div class="fyi">
                    <ul>
                        <li><strong><?php echo __('Version', ST_TEXTDOMAIN);?>:</strong> <?php echo esc_html($api['version']);?></li>
                        <li><strong><?php echo __('Author', ST_TEXTDOMAIN);?>:</strong> <a href="<?php echo esc_url($api['url-author']);?>" target="_blank"><?php echo esc_html($api['author']);?></a></li>
                        <li><strong><?php echo __('Last Updated', ST_TEXTDOMAIN);?>:</strong> <?php echo esc_html($api['last_updated']);?> </li>
                        <li>
                            <strong><?php echo __('Requires WordPress Version', ST_TEXTDOMAIN);?>:</strong> <?php echo esc_html($api['requires']);?> </li>
                    </ul>
