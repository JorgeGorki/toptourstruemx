        ...
        class STUser_f extends TravelerObject
        {
            ...
            public function st_partner_flight_tabs_more($fields){
                array_push($fields, array(
                    'name' => 'payments',
                    'label' => __('Payments', ST_TEXTDOMAIN)
                ));
                        ...
                        if(STInput::request( 'is_featured', 'off' ) === 'on'){
                            if ( $admin_packages->enabled_membership() ) {
                                ...
                                if ( $admin_packages->get_user_role() == 'partner' && ( $num_set_featured !== 'unlimited' && $num_set_featured <= 0 ) ) {
                                    $validator->set_error_message( 'is_featured',sprintf( __( "You cannot set featured for this rental. Your remaining item is %s (items)", ST_TEXTDOMAIN ), $num_set_featured ));
                                }
                            }
                        }
                        break;
            ...
            public function st_partner_rental_info($fields){
                ...
                $arr_temp =  array(
                    array(
                        'type' => 'select',
                        'label' => __('Select contact info will be shown?', ST_TEXTDOMAIN),
                    ...
                    array(
                        ...
                        'plh' => '',
                        'options' => array(
                            'instant' => __( 'Instant Booking', ST_TEXTDOMAIN ),
                            'enquire' => __( 'Enquire Booking', ST_TEXTDOMAIN ),
                            'instant_enquire' => __( 'Instant & Enquire Booking', ST_TEXTDOMAIN ),
                        ),
                        'std'     => 'instant',
                        'seperate' => true
                    ),
            ...
            private function stCarValidate($step = 1){
                ...
                switch ($step){
                    case 1:
                        ...
                        if(STInput::request( 'is_featured', 'off' ) === 'on'){
                            if ( $admin_packages->enabled_membership() ) {
                                $num_set_featured = $admin_packages->count_item_can_featured( get_current_user_id(), STInput::get( 'id', '' ) );
                                if ( $admin_packages->get_user_role() == 'partner' && ( $num_set_featured !== 'unlimited' && $num_set_featured <= 0 ) ) {
                                    $validator->set_error_message( 'is_featured',sprintf( __( "You cannot set featured for this car. Your remaining item is %s (items)", ST_TEXTDOMAIN ), $num_set_featured ));
                                }
                            }
                        }
                        break;
                    case 2:
                        ...
                        $validator->set_rules('cars_email', __("Contact email", ST_TEXTDOMAIN), 'valid_email');
            ...
            private function stActivityValidate($step = 1){
                ...
                switch ($step){
                    case 1:
                        ...
                        $validator->set_rules('st_content', __("Content", ST_TEXTDOMAIN), 'required');
                        $validator->set_rules('st_desc', __("Short Intro", ST_TEXTDOMAIN), 'required');
                        $validator->set_rules('contact_email', __("Email", ST_TEXTDOMAIN), 'valid_email');
                        ...
                        if(STInput::request( 'is_featured', 'off' ) === 'on'){
                            if ( $admin_packages->enabled_membership() ) {
                                $num_set_featured = $admin_packages->count_item_can_featured( get_current_user_id(), STInput::get( 'id', '' ) );
                                if ( $admin_packages->get_user_role() == 'partner' && ( $num_set_featured !== 'unlimited' && $num_set_featured <= 0 ) ) {
                                    $validator->set_error_message( 'is_featured',sprintf( __( "You cannot set featured for this activity. Your remaining item is %s (items)", ST_TEXTDOMAIN ), $num_set_featured ));
                                }
                            }
                        }
                        break;
            ...
            public function st_partner_activity_info($fields){
                ...
                $new_arr = array(
                    ...
                    array(
                        'type' => 'textarea',
                        'label' => __('Activity Included', ST_TEXTDOMAIN),
                    ...
                    array(
                        'type' => 'textarea',
                        'label' => __('Activity Excluded', ST_TEXTDOMAIN),
            ...
            private function stTourValidate($step = 1){
                ...
                switch ($step){
                    case 1:
                        ...
                        if(STInput::request( 'is_featured', 'off' ) === 'on'){
                            if ( $admin_packages->enabled_membership() ) {
                                $num_set_featured = $admin_packages->count_item_can_featured( get_current_user_id(), STInput::get( 'id', '' ) );
                                if ( $admin_packages->get_user_role() == 'partner' && ( $num_set_featured !== 'unlimited' && $num_set_featured <= 0 ) ) {
                                    $validator->set_error_message( 'is_featured',sprintf( __( "You cannot set featured for this tour. Your remaining item is %s (items)", ST_TEXTDOMAIN ), $num_set_featured ));
                                }
                            }
                        }
                        // $validator->set_rules('st_desc', __("Short Intro", ST_TEXTDOMAIN), 'required');
                    ...
                    case 4:
                        if(isset($_REQUEST['tour_price_by'])){
                            $validator->set_rules('tour_price_by', __("Price type", ST_TEXTDOMAIN), 'required');
                            $tour_price_type = $_REQUEST['tour_price_by'];
            ...
            public function st_partner_tour_tabs_payment($fields){
                ...
                if (!empty($id)) {
                    if (!empty($sc) && $sc == 'edit-tours') {
                        array_push($fields, array(
                            'name' => 'package',
                            'label' => __('Packages', ST_TEXTDOMAIN)
                        ));
                        array_push($fields, array(
                            'name' => 'availability',
                            'label' => __('Availability', ST_TEXTDOMAIN)
            ...
            public function st_partner_tour_info($fields){
                ...
                $new_arr = array(
                    ...
                    array(
                        'type' => 'textarea',
                        'label' => __('Tour Included', ST_TEXTDOMAIN),
                        'name' => 'tours_include',
                        'col' => '6',
                        'plh' => '',
                        'required' => false,
                    ...
                    array(
                        'type' => 'textarea',
                        'label' => __('Tour Excluded', ST_TEXTDOMAIN),
                        'name' => 'tours_exclude',
                        'col' => '6',
                        'plh' => '',
                        'required' => false,
            ...
            private function stHotelRoomValidate($step = 1){
                ...
                switch ($step){
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        $validator->set_rules('price_by_per_person', __("Allow price per person", ST_TEXTDOMAIN), 'required');
            ...
            public function st_partner_hotel_room_content_payment($fields){
                if ( st()->get_option('use_woocommerce_for_booking') == 'on' ) {
                    if (empty($fields['payments'])) {
                        $fields['payments'][] = [
                            'type' => 'label',
                            'label' => __('Using payment method of Woocommerce Plugin.', ST_TEXTDOMAIN),
                            'col' => '12',
                            'clear' => true
                        ];
                    }
                    ...
                    if (empty($fields['payments'])) {
                        $fields['payments'][] = [
                            'type' => 'label',
                            'label' => __('No Payment Method is enabled.', ST_TEXTDOMAIN),
                            'col' => '12',
                            'clear' => true
                        ];
                    }
                    ...
                    case 1:
                        ...
                        if(STInput::request( 'is_featured', 'off' ) === 'on'){
                            if ( $admin_packages->enabled_membership() ) {
                                $num_set_featured = $admin_packages->count_item_can_featured( get_current_user_id(), STInput::get( 'id', '' ) );
                                if ( $admin_packages->get_user_role() == 'partner' && ( $num_set_featured !== 'unlimited' && $num_set_featured <= 0 ) ) {
                                    $validator->set_error_message( 'is_featured',sprintf( __( "You cannot set featured for this hotel. Your remaining item is %s (items)", ST_TEXTDOMAIN ), $num_set_featured ));
                                }
                            }
                        }
                        break;
            ...
            public function reset_password()
            {
                if ( STInput::post( 'action', '' ) == 'reset_password' &&
                    ...
                    if ( $update_user ) {
                        $to      = $email;
                        $subject = __('Your new password',ST_TEXTDOMAIN);
                        $sender  = get_option( 'name' );

                        $message = __('Your new password is:',ST_TEXTDOMAIN) .' '. $random_password;
            ...
            public function st_filter_car_wishlist_ajax_func(){
                ...
                <span class="count-string">
                    ...
                    if ($query->found_posts):
                        ...
                        echo sprintf(__('%d - %d of %d ', ST_TEXTDOMAIN), (int)$posts_per_page * ($page - 1) + 1, $last, $query->found_posts );
                        echo ( $query->found_posts == 1 ) ? __( 'Car', ST_TEXTDOMAIN ) : __( 'Cars', ST_TEXTDOMAIN );
                    endif;
                    ?>
                </span>
                <?php
                ...
                $count  = balanceTags( $this->get_result_string('hotel') ) . '<div id="btn-clear-filter" class="btn-clear-filter" style="display: none;">' . __('Clear filter', ST_TEXTDOMAIN) . '</div>';
                $result = [
            ...
            public function st_filter_rental_wishlist_ajax_func(){
                ...
                $count  = balanceTags( $this->get_result_string('tour') ) . '<div id="btn-clear-filter" class="btn-clear-filter" style="display: none;">' . __('Clear filter', ST_TEXTDOMAIN) . '</div>';
            ...
            public function st_filter_activity_wishlist_ajax_func(){
                ...
                <span class="count-string">
                    ...
                    if ($query->found_posts):
                        ...
                        if ($last > $query->found_posts) $last = $query->found_posts;
                        echo sprintf(__('%d - %d of %d ', ST_TEXTDOMAIN), (int)$posts_per_page * ($page - 1) + 1, $last, $query->found_posts );
                        echo ( $query->found_posts == 1 ) ? __( 'Activity', ST_TEXTDOMAIN ) : __( 'Activities', ST_TEXTDOMAIN );
                    endif;
                    ?>
                </span>
                <?php
            ...
            public function st_filter_tour_wishlist_ajax_func(){
                ...
                <span class="count-string">
                    ...
                    if ($query->found_posts):
                        ...
                        if ($last > $query->found_posts) $last = $query->found_posts;
                        echo sprintf(__('%d - %d of %d ', ST_TEXTDOMAIN), (int)$posts_per_page * ($page - 1) + 1, $last, $query->found_posts );
                        echo ( $query->found_posts == 1 ) ? __( 'Tour', ST_TEXTDOMAIN ) : __( 'Tours', ST_TEXTDOMAIN );
                    endif;
                    ?>
                </span>
                <?php
            ...
            function get_result_string($service_label)
            {
                ...
                if ( $query->found_posts ) {
                    if ( $query->found_posts > 1 ) {
                        $p2 = sprintf( __( '%s %s found', ST_TEXTDOMAIN ), $query->found_posts , $service_label );
                    } else {
                        $p2 = sprintf( __( '%s %s found', ST_TEXTDOMAIN ), $query->found_posts,$service_label );
                    }
                } else {
                    $p2 = sprintf( __( 'No %s found', ST_TEXTDOMAIN ), $service_label );
                }
                ...
                if ( !empty( $pageposts ) ) {
                    foreach ( $pageposts as $key => $value ) {
                        ...
                        if ( TravelerObject::check_cancel_able( $value->order_item_id ) && $value->type == 'normal_booking' ) {
                            ...
                            $action .= '<a  data-toggle="modal" data-target="#cancel-booking-modal" class="btn btn-xs btn-primary mt5 confirm-cancel-booking" href="javascript: void(0);" data-order_id="' . $value->order_item_id . '" data-order_encrypt="' . TravelHelper::st_encrypt( $value->order_item_id ) . '"><i class="fa fa fa-ban"></i><span class="hidden-xs">' . __( 'Cancel Booking', ST_TEXTDOMAIN ) . '</span></a>';
                        }
                        $action .= '<a data-toggle="modal" data-target="#info-booking-modal" class="btn btn-xs btn-primary mt5 btn-info-booking" data-service_id=' . $id_item . ' data-order_id="' . $value->order_item_id . '" href="javascript: void(0);"><i class="fa fa-info-circle"></i><span class="hidden-xs">' . __( ' Details', ST_TEXTDOMAIN ) . '</span></a>';
            ...
            function get_type_order_item_not_icon( $id_item, $type = false){
                ...
                if ( $type == 'car_transfer' ) {
                    $html = '<small>' . __( "transfer", ST_TEXTDOMAIN ) . '</small>';
                } else {
                    $post_type = get_post_type( $id_item );
                    switch ( $post_type ) {
                        case "st_hotel":
                            $html = '<small>' . __( "hotel", ST_TEXTDOMAIN ) . '</small>';
                            break;
                        case "hotel_room":
                            $html = '<small>' . __( "room", ST_TEXTDOMAIN ) . '</small>';
                            break;
                        case "st_tours":
                            $html = '<small>' . __( 'tour', ST_TEXTDOMAIN ) . '</small>';
                            break;
                        case "st_cars":
                            $html = '<small>' . __( "car", ST_TEXTDOMAIN ) . '</small>';
                            break;
                        case "st_rental":
                            $html = '<small>' . __( "rental", ST_TEXTDOMAIN ) . '</small>';
                            break;
                        case "st_activity":
                            $html = '<small>' . __( "activity", ST_TEXTDOMAIN ) . '</small>';
                            break;
                        case "cruise_cabin":
                            $html = '<small>' . __( "cruise", ST_TEXTDOMAIN ) . '</small>';
                            break;
                        case "st_flight":
                            $html = '<small>' . __( "flight", ST_TEXTDOMAIN ) . '</small>';
                            break;
                        default :
                            $html = '';
                    }
