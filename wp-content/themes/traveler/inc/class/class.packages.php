        ...
        class STPackages extends TravelerObject
        {
            ...
            public function  direct_submit_package_form(){
                ...
                if(STInput::post('st_first_name','') == ''){
                    $error .= '<p>'.__( 'The firstname is required', ST_TEXTDOMAIN ).'</p>';
                }
                if(STInput::post('st_last_name','') == ''){
                    $error .= '<p>'.__( 'The lastname is required', ST_TEXTDOMAIN ).'</p>';
                }

                if(STInput::post('st_email','') == ''){
                    $error .= '<p>'.__( 'The email is required', ST_TEXTDOMAIN ).'</p>';
                }

                if(STInput::post('st_phone','') == ''){
                    $error .= '<p>'.__( 'The phone number is required', ST_TEXTDOMAIN ).'</p>';
                }
                ...
                if ( !$payment_gateway_id || !$payment_gateway_used ) {
                    ...
                    $error .= '<p>'.sprintf( __( 'Sorry! Payment Gateway: <code>%s</code> is not available for this item!', ST_TEXTDOMAIN ), $payment_gateway_name ).'</p>';
                }
                //=== Check cart
