...
//        ) ) );
        ...
        add_action( 'wp_default_scripts', 'st_replace_scripts', -1 );
    }
...
if (! function_exists('st_replace_scripts')) {
    /*
    ...
    */
    function st_replace_scripts( $scripts ) {
        st_set_script( $scripts, 'jquery-migrate', get_template_directory_uri() . '/js/jquery-migrate-1.4.1-wp.js', array(), '1.4.1-wp' );
        st_set_script( $scripts, 'jquery', false, array( 'jquery-core', 'jquery-migrate' ), '1.12.4-wp' );
    }
}
...
if (!function_exists('st_wp_title')) {
    ...
    function st_wp_title($title) {
        ...
        if (is_search()) {
            ...
            if ($extra)
                $extra = __('Search ', ST_TEXTDOMAIN) . $extra;
...
//            wp_enqueue_script( 'custom.js', get_template_directory_uri() . '/js/custom.js', [ 'jquery' ], null, true );
        ...
        wp_localize_script('jquery', 'st_params', [
            ...
            'text_origin_price' => __("Origin Price", ST_TEXTDOMAIN),
            'text_unavailable' => __('Not Available ', ST_TEXTDOMAIN),
            'text_available' => __('Available ', ST_TEXTDOMAIN),
            'text_adult_price' => __('Adult Price ', ST_TEXTDOMAIN),
            'text_child_price' => __('Child Price ', ST_TEXTDOMAIN),
            'text_update' => __('Update ', ST_TEXTDOMAIN),
            'text_adult' => __('Adult ', ST_TEXTDOMAIN),
            'text_child' => __('Child ', ST_TEXTDOMAIN),
            'token_mapbox' => $st_token_mapbox,
            'text_use_this_media' => __('Use this media', ST_TEXTDOMAIN),
            'st_icon_mapbox' => $st_icon_mapbox,
            'text_rtl_mapbox' => $text_rtl_mapbox,
            'text_select_image' => __('Select Image', ST_TEXTDOMAIN),
            'text_confirm_delete_item' => __('Are you sure want to delete this item?', ST_TEXTDOMAIN),
            'text_process_cancel' => __('You cancelled the process', ST_TEXTDOMAIN),
            'prev_month' => __('prev month', ST_TEXTDOMAIN),
            'next_month' => __('next month', ST_TEXTDOMAIN),
            'please_waite' => __('Please wait...', ST_TEXTDOMAIN),
        ...
        wp_localize_script('jquery', 'locale_daterangepicker', [
            ...
            'applyLabel' => __('Apply', ST_TEXTDOMAIN),
            'cancelLabel' => __('Cancel', ST_TEXTDOMAIN),
            'fromLabel' => __('From', ST_TEXTDOMAIN),
            'toLabel' => __('To', ST_TEXTDOMAIN),
            'customRangeLabel' => __('Custom', ST_TEXTDOMAIN),
            'daysOfWeek' =>  [__('Su', ST_TEXTDOMAIN), __('Mo', ST_TEXTDOMAIN), __('Tu', ST_TEXTDOMAIN), __('We', ST_TEXTDOMAIN), __('Th', ST_TEXTDOMAIN), __('Fr', ST_TEXTDOMAIN), __('Sa', ST_TEXTDOMAIN)],
            'monthNames' => [__('January', ST_TEXTDOMAIN), __('February', ST_TEXTDOMAIN), __('March', ST_TEXTDOMAIN), __('April', ST_TEXTDOMAIN), __('May', ST_TEXTDOMAIN), __('June', ST_TEXTDOMAIN), __('July', ST_TEXTDOMAIN), __('August', ST_TEXTDOMAIN), __('September', ST_TEXTDOMAIN), __('October', ST_TEXTDOMAIN), __('November', ST_TEXTDOMAIN), __('December', ST_TEXTDOMAIN)],
            'firstDay' => (int)st()->get_option('start_week', 0),
            'today' => __('Today', ST_TEXTDOMAIN),
            'please_waite' => __('Please wait...', ST_TEXTDOMAIN),
            'buttons' => __('buttons', ST_TEXTDOMAIN),
        ]);
...
function st_send_email_single_service() {
    ...
    if (empty($name_st) || (empty($email_st)) || (empty($phone_st)) || (empty($content_st))) {
        ...
        $body_email .= "<strong>" . __('Type Service', ST_TEXTDOMAIN) . "</strong>: " . $type_service . "<br/>" .
                ...
                "<strong>" . __('Note', ST_TEXTDOMAIN) . "</strong>: " . $content_st . "<br/></html></body>";
