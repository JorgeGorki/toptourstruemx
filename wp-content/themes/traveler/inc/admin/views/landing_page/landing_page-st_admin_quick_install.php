                                ...
                                <div class="theme">
                                    ...
                                    <div class="theme-actions-demo">
                                        <ul class="theme-name" id="classic" style="display: flex;justify-content: space-between;height: 27px;">
                                            ...
                                            <li><a onclick="return false" class="button button-primary st-quick-install-demo" data-demo-id="<?php echo esc_attr($key) ?>" href="#"><?php _e('Install',ST_TEXTDOMAIN)?></a></li>
                                        </ul>
            ...
            <div class="st-modal-dialog">
                ...
                <div class="st-modal-content">
                    <div class="form-group import">
                        ...
                        <h3 class="control-label st-center"><?php echo __('Processing...',ST_TEXTDOMAIN);?></h3>
