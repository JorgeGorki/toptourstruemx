...
<div class="wrap woocommerce">
    ...
    <form action="" method="post">
        <table class="form-table">
            ...
            <tr class="form-field form-required">
                <th scope="row" valign="top">
                    <label for="attribute_name"><?php _e( 'Slug (Required)', ST_TEXTDOMAIN ); ?></label>
                </th>
                <td>
                    <input name="attribute_name" id="attribute_name" type="text" readonly="readonly" value="<?php echo esc_attr( $row['tax'] ); ?>" maxlength="28" />
                    <p class="description"><?php _e( 'Unique slug/reference for the attribute; must be shorter than 28 characters and type Alphabet.', ST_TEXTDOMAIN ); ?></p>
                </td>
            </tr>
