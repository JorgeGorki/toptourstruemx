    ...
    <table class="table table-bordered table-striped table-booking-history">
        ...
        while (have_posts()): the_post();
            ...
            if ((float)$post->cancel_refund > 0 && $post->cancel_refund_status == 'pending') {
                ...
                $action_cancel = '<br /><a data-toggle="modal" data-target="#with-refund-modal" href="javascript: void(0);" class="with_a_refund btn btn-primary btn-xs" data-order_id="' . esc_attr($post->order_item_id) . '" data-order_encrypt="' . esc_attr(TravelHelper::st_encrypt($post->order_item_id)) . '">' . __('with refund', ST_TEXTDOMAIN) . '</a>';
    ...
    <div class="modal-dialog modal-md" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default close-modal" data-dismiss="modal"><?php echo __("Close", ST_TEXTDOMAIN); ?></button>
