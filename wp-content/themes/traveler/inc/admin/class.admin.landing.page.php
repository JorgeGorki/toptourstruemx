        ...
        public function st_optimize_metadata_post(){
            ...
            if(is_user_logged_in()) {
                ...
                if(!empty($st_optimize_meta_key) && ($st_optimize_meta_key === 'yes')){
                    ...
                    $wpdb->query($sql);
                    echo json_encode(array('message' => __('Successfully', ST_TEXTDOMAIN)));
                } else {
                    echo json_encode(array('message' => __('Please confirm by keyword  : yes', ST_TEXTDOMAIN)));
                }
        ...
        static function sub_menu_list()
        {
            ...
            if (!self::register_completed()) {
                array_push($return,
                    ...
                    array(
                        'page_title' => __("Theme Notification", ST_TEXTDOMAIN),
                        'menu_title' => __("Theme Notification", ST_TEXTDOMAIN),
            ...
            array_push($return,
                ...
                // ),
                array(
                    'page_title' => __("Quick Install Demo", ST_TEXTDOMAIN),
                    'menu_title' => __("Quick Install Demo", ST_TEXTDOMAIN),
